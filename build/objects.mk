...
AGENT_PORT_NEW = src/agent/port_agent_redact_helpers.o src/agent/port_agent_tool_dispatch_helpers.o src/agent/port_agent_verify_hooks.o src/agent/port_agent_ssl_verify.o src/agent/port_agent_turn_context.o src/agent/port_billing_links.o src/agent/port_billing_usage.o src/agent/port_battery.o src/agent/port_aux_accounting.o src/agent/port_async_utils.o src/agent/hermes_state/hermes_state_open.o src/agent/hermes_state/hermes_state_lifecycle.o src/agent/hermes_state/hermes_state_messages.o src/agent/hermes_state/hermes_state_lineage.o src/agent/hermes_state/hermes_state_tokens.o src/agent/hermes_state/hermes_state_archive.o src/agent/hermes_state/hermes_state_repair.o src/agent/hermes_state/hermes_state_locks.o src/agent/conversation_compression_helpers.o src/cli/session_recovery/session_recovery_paths.o src/cli/session_recovery/session_recovery_preflight.o src/cli/session_recovery/session_recovery_copy.o src/cli/session_recovery/session_recovery_salvage.o src/cli/session_recovery/session_recovery_meta.o src/cli/session_recovery/session_recovery_orphans.o src/cli/session_recovery/session_recovery_verify.o src/cli/session_recovery/session_recovery_main.o
TOOLS_PORT_NEW = src/tools/port_file_operations_search.o src/tools/port_tools_slash_confirm.o src/tools/port_interrupt.o src/cli/port_moa_pure_helpers.o src/cli/port_config_py_pure.o src/cli/port_config_py_io.o src/cli/port_models_py_helpers.o src/tools/port_research_helpers.o src/cli/port_moa_config_pure.o src/cli/port_moa_slash.o src/cli/port_input_sanitize.o src/cli/port_utils_truthy.o src/cli/port_session_title.o src/cli/port_state_usage_db.o src/tools/port_toolsets.o src/cli/port_platform_tools.o
GATEWAY_PORT_NEW = src/cli/port_gateway_platforms_helpers.o src/gateway/port_gateway_drain_control.o src/gateway/run_pure2.o src/gateway/port_slash_command_guards.o src/gateway/port_gateway_run_deps.o src/gateway/port_slash_commands.o src/gateway/port_hermes_constants_reasoning.o src/gateway/port_gateway_run_agent.o src/cli/port_provider_registry.o
AGENT_PORT_REGEN = src/agent/port_agent_reasoning_timeouts.o src/agent/port_agent_replay_cleanup.o src/agent/port_agent_retry_utils.o src/agent/port_agent_thinking_timeout_guidance.o src/agent/port_agent_intent_ack.o src/agent/port_agent_display_helpers.o src/agent/port_markdown_tables.o src/agent/port_agent_auxiliary_client_helpers.o src/agent/port_agent_auxiliary_client_runtime.o src/agent/port_moa_trace_helpers.o src/agent/port_lsp_range_shift.o src/agent/transport_common.o $(AGENT_PORT_NEW)
