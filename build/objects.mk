...
AGENT_PORT_NEW = src/agent/port_agent_redact_helpers.o src/agent/port_agent_tool_dispatch_helpers.o src/agent/port_agent_verify_hooks.o src/agent/port_agent_ssl_verify.o src/agent/port_agent_turn_context.o src/agent/port_billing_links.o src/agent/port_billing_usage.o src/agent/port_battery.o src/agent/port_aux_accounting.o src/agent/port_async_utils.o src/agent/hermes_state/hermes_state_open.o src/agent/hermes_state/hermes_state_lifecycle.o src/agent/hermes_state/hermes_state_messages.o src/agent/hermes_state/hermes_state_lineage.o src/agent/hermes_state/hermes_state_tokens.o src/agent/hermes_state/hermes_state_archive.o src/agent/hermes_state/hermes_state_misc.o src/agent/hermes_state/hermes_state_repair.o src/agent/hermes_state/hermes_state_locks.o src/agent/port_iron_proxy.o src/agent/port_secret_sources_helpers.o src/agent/conversation_compression_helpers.o src/cli/session_recovery/session_recovery_paths.o src/cli/session_recovery/session_recovery_preflight.o src/cli/session_recovery/session_recovery_copy.o src/cli/session_recovery/session_recovery_salvage.o src/cli/session_recovery/session_recovery_meta.o src/cli/session_recovery/session_recovery_orphans.o src/cli/session_recovery/session_recovery_verify.o src/cli/session_recovery/session_recovery_main.o src/agent/port_agent_coding_context.o src/agent/port_agent_background_review.o src/agent/port_antigravity_oauth.o
