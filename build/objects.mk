...
CLI_OBJ = src/cli/cli.o src/cli/commands.o src/cli/config.o src/cli/config_env.o src/cli/config_platforms.o src/cli/config_profile.o src/cli/config_diff.o src/cli/config_io.o src/cli/config_schema.o src/cli/config_migrate.o src/cli/config_setup.o src/cli/config_schema.o src/cli/paths.o src/cli/display.o src/cli/display_core.o src/cli/main.o src/cli/doctor.o src/cli/setup_wizard.o src/cli/cli_gaps.o src/cli/port_context_switch_guard.o src/cli/port_gateway_windows.o src/cli/port_nous_billing.o src/cli/port_nous_billing_remaining.o src/cli/port_nous_subscription_remaining.o src/cli/port_proxy_xai_remaining.o src/cli/port_proxy_adapters_base_remaining.o src/cli/port_console_engine_remaining.o src/cli/port_voice.o src/cli/port_config_pure.o src/cli/port_status_helpers.o src/cli/port_cli_logs.o src/cli/cli_cmd_system.o src/cli/cli_cmd_help.o src/cli/cli_cmd_session.o src/cli/cli_cmd_config.o src/cli/cli_cmd_misc.o src/cli/cli_cmd_gateway.o src/cli/cli_cmd_skills.o src/cli/cli_cmd_tools.o src/cli/cli_cmd_mcp.o src/cli/cli_cmd_kanban.o src/cli/cli_cmd_security.o src/cli/cli_cmd_memory.o src/cli/cli_cmd_display.o src/cli/port_model_cost_guard.o src/cli/port_cli_profiles.o src/cli/port_web_server_status.o src/cli/port_web_server_managed_files.o src/cli/port_web_server_fs.o src/cli/port_web_server_events.o src/cli/port_web_server_console.o src/cli/port_web_server_themes.o src/cli/port_web_server_ws_auth.o src/cli/hermes_cli_ws_tickets.o src/cli/port_web_server_chat_argv.o src/cli/port_web_server_cron_dash.o src/cli/port_web_server_sessions_admin.o src/cli/port_web_server_session_detail.o src/cli/port_web_server_session_endpoints.o src/cli/port_web_server_prune.o src/cli/port_default_soul.o src/cli/port_agent_browser_provider_methods.o src/cli/port_agent_gemini_cloudcode_adapter_methods.o src/cli/port_agent_think_scrubber.o src/cli/port_agent_tts_provider_methods.o src/cli/port_hermes_cli_dashboard_auth_prefix.o src/cli/port_hermes_cli_hooks.o src/cli/port_hermes_cli_prompt_size.o src/cli/port_hermes_cli_voice.o src/cli/port_hermes_cli_write_approval_commands.o src/cli/display_diff.o \
...
PORT_OBJ = \
    ...
    src/cli/port_code_execution_helpers.o \
        ...
        src/tools/port_skills_hub.o src/tools/port_skills_hub_remaining.o src/tools/port_skill_manager_tool_remaining.o src/tools/port_skill_usage_remaining.o src/tools/port_todo_tool_remaining.o \
        ...
        src/cli/port_dump.o src/cli/port_dump_remaining.o src/cli/port_journey_remaining.o src/cli/port_kanban_decompose_remaining.o src/cli/port_pairing_remaining.o \
        ...
        src/cli/port_kanban_diagnostics.o src/cli/port_kanban_diagnostics_remaining.o src/cli/port_nous_account_remaining.o src/cli/port_nous_portal_remaining.o src/cli/port_uninstall_remaining.o src/cli/port_proxy_cli_remaining.o src/cli/port_windows_ssh_runtime_remaining.o src/cli/port_hermes_state_remaining2.o \
...
AGENT_OBJ = src/agent/agent_loop.o src/agent/agent_runtime_helpers.o src/agent/port_agent_runtime_helpers_remaining.o src/agent/chat_completion_helpers.o src/agent/credential_pool_engine.o src/agent/credential_pool_persistence.o src/agent/credential_pool_custom.o src/agent/credential_pool_sync.o src/agent/port_credential_pool_remaining.o src/agent/credential_sources.o src/agent/llm_client.o src/agent/credential_persistence.o src/agent/logger.o src/agent/context.o src/agent/context_compressor_pure.o src/agent/context_engine.o src/agent/coding_context.o src/agent/stream_diag.o src/agent/port_stream_diag_remaining.o src/agent/title.o src/agent/provider.o src/agent/provider_openai.o src/agent/provider_openrouter.o src/agent/provider_deepseek.o src/agent/provider_xai.o src/agent/provider_anthropic.o src/agent/provider_google.o src/agent/provider_azure.o src/agent/provider_bedrock.o src/agent/process_bootstrap.o src/agent/provider_custom.o src/agent/provider_codex_responses.o src/agent/codex_app_server_client.o src/agent/codex_app_server_session.o src/agent/codex_event_projector.o src/agent/port_codex_event_projector_remaining.o src/agent/hermes_tools_mcp_server.o src/agent/port_hermes_tools_mcp_server_remaining.o src/agent/fallback_routing.o src/agent/budget_tracker.o src/agent/provider_metadata.o src/agent/checkpoint.o src/agent/plugin_ext.o src/agent/redact.o src/agent/audit.o src/agent/sanitize.o src/agent/vault.o src/agent/think_scrubber.o src/agent/port_think_scrubber_remaining2.o src/agent/retry_utils.o src/agent/port_retry_utils_remaining.o src/agent/port_thread_scoped_output_remaining.o src/agent/trajectory.o src/agent/port_trajectory_remaining.o src/agent/portal_tags.o src/agent/port_portal_tags_remaining.o src/agent/markdown_tables.o src/agent/port_markdown_tables_remaining.o src/agent/markdown_render.o src/agent/file_safety.o src/agent/system_prompt.o src/agent/port_system_prompt_remaining.o src/agent/skill_preprocessing.o src/agent/port_skill_preprocessing_remaining.o src/agent/tool_guardrails.o src/agent/port_tool_guardrails_remaining.o src/agent/i18n.o src/agent/port_i18n_remaining.o src/agent/subdir_hints.o src/agent/port_subdirectory_hints_remaining.o src/agent/onboarding.o src/agent/image_routing.o src/agent/skill_bundles.o src/agent/usage_pricing.o src/agent/lmstudio_reasoning.o src/agent/context_breakdown.o src/agent/manual_compression_feedback.o src/agent/prompt_caching.o src/agent/port_prompt_caching_remaining.o src/agent/context_references.o src/agent/port_context_references_remaining.o src/agent/port_curator_backup_remaining.o src/agent/port_plugin_llm_remaining.o src/agent/port_context_engine_remaining.o src/agent/port_file_safety_remaining.o src/agent/port_conversation_loop_remaining.o src/agent/port_credential_sources_remaining.o src/agent/port_memory_manager_remaining.o src/agent/port_video_gen_provider_remaining.o src/agent/port_video_gen_registry_remaining.o src/agent/port_codex_app_server_session_remaining.o src/agent/port_azure_identity_adapter_remaining.o src/agent/port_lsp_manager_remaining.o src/agent/port_lsp_workspace_remaining.o src/agent/port_lsp_reporter_remaining.o src/agent/port_onepassword_remaining.o src/agent/port_skill_bundles_remaining.o src/agent/port_chat_completions_remaining.o src/agent/port_skill_commands_remaining.o src/agent/gemini_schema.o src/agent/moonshot_schema.o src/agent/port_moonshot_schema_remaining.o src/agent/auxiliary_client.o src/agent/port_auxiliary_client_remaining2.o src/agent/port_memory_provider_remaining.o src/agent/browser_provider.o src/agent/port_browser_provider_remaining.o src/agent/browser_registry.o src/agent/port_browser_registry_remaining.o src/agent/tool_error.o src/agent/hook_registry.o src/agent/shell_hooks.o src/agent/port_shell_hooks_remaining.o src/agent/ssl_guard.o src/agent/port_ssl_guard_remaining.o src/agent/port_web_search_registry_remaining.o src/agent/port_web_search_provider_remaining.o src/agent/nous_rate_guard.o src/agent/port_nous_rate_guard_remaining.o src/agent/agent_gaps.o src/agent/todo_hydrate.o src/agent/file_mutation_verifier.o src/agent/api_error_summary.o src/agent/transcription_provider.o src/agent/port_transcription_provider_remaining.o src/agent/port_transcription_registry_remaining.o src/agent/verification_evidence.o src/agent/curator.o src/agent/port_curator_remaining.o src/agent/plugin_llm.o src/agent/tool_executor.o src/agent/port_tool_executor_remaining.o src/agent/google_code_assist.o src/agent/copilot_acp_client.o src/agent/port_copilot_acp_client_remaining.o src/agent/port_copilot_acp_client_remaining2.o src/agent/azure_identity_adapter.o src/agent/agent_message_repair.o src/agent/agent_message_sanitize.o src/agent/proxy_utils.o src/agent/credits_tracker.o src/agent/turn_context.o src/agent/turn_retry_state.o src/agent/turn_retry_state.o src/agent/agent_init.o src/agent/port_agent_init_remaining.o src/agent/port_iteration_budget_remaining.o src/agent/port_moa_loop_remaining.o src/agent/title_generator.o src/agent/port_title_generator_remaining.o src/provider/token_exchange.o src/provider/google_oauth.o src/provider/copilot_oauth.o src/acp/server.o src/acp/edit_approval.o src/acp/events.o src/acp/permissions.o src/acp/resource.o src/tools/rate_limit.o src/tools/tool_result.o src/agent/skill_commands.o src/agent/memory_provider.o src/agent/anthropic_adapter.o src/agent/async_utils.o src/agent/background_review.o src/agent/port_background_review_remaining.o src/agent/bedrock_adapter.o src/agent/port_bedrock_adapter_remaining.o src/agent/codex_responses_adapter.o src/agent/port_codex_responses_adapter_remaining.o src/agent/port_codex_app_server_remaining.o src/agent/codex_runtime.o src/agent/context_compressor.o src/agent/conversation_compression.o src/agent/conversation_loop.o src/agent/turn_finalizer.o src/agent/gemini_cloudcode_adapter.o src/agent/gemini_native_adapter.o src/agent/port_gemini_native_adapter_remaining.o src/agent/port_gemini_native_remaining2.o src/agent/port_redact_remaining.o src/agent/port_image_routing_remaining.o src/agent/port_transports_codex_remaining.o src/agent/port_transports_anthropic_remaining.o src/agent/port_secret_sources_cache_remaining.o src/agent/port_transports_bedrock_remaining.o src/agent/port_transports_base_remaining.o src/agent/port_transports_init_remaining.o src/agent/port_model_metadata_remaining.o src/agent/port_usage_pricing_remaining.o src/agent/port_conversation_compression_remaining.o src/agent/port_chat_completion_helpers_remaining.o src/agent/port_lsp_install_remaining.o src/agent/port_credits_tracker_remaining.o src/agent/port_transports_types_remaining.o src/agent/port_image_gen_provider_remaining.o src/agent/port_image_gen_registry_remaining.o src/agent/port_onboarding_remaining.o src/agent/port_message_sanitization_remaining.o src/agent/port_secret_sources_command_remaining.o src/agent/port_secret_sources_base_remaining.o src/agent/port_secret_sources_registry_remaining.o src/agent/port_lsp_cli_remaining.o src/agent/insights.o src/agent/port_insights_remaining.o src/agent/message_sanitization.o src/agent/model_metadata.o src/agent/models_dev.o src/agent/port_models_dev_remaining.o src/agent/prompt_builder.o src/agent/port_prompt_builder_remaining.o src/agent/prompt_builder_guidance.o src/agent/runtime_cwd.o src/agent/port_runtime_cwd_remaining.o src/agent/subdirectory_hints.o src/agent/port_agent_antigravity_code_assist.o src/agent/port_agent_antigravity_oauth.o src/agent/port_agent_auxiliary_client.o src/agent/port_agent_billing_view.o src/agent/port_agent_context_compressor.o src/agent/port_agent_conversation_loop.o src/agent/port_agent_display.o src/agent/port_agent_image_gen_provider.o src/agent/port_agent_memory_manager.o src/agent/port_agent_memory_provider.o src/agent/port_agent_message_content.o src/agent/port_message_content_remaining.o src/agent/port_agent_prompt_builder.o src/agent/port_agent_secret_scope.o src/agent/port_agent_skill_commands.o src/agent/port_agent_skill_utils.o src/agent/port_agent_system_prompt.o src/agent/port_agent_title_generator.o src/agent/port_agent_tool_executor.o src/agent/port_memory_manager_helpers.o src/agent/port_agent_learn_prompt.o
...
src/tools/file_batch.o src/tools/file_watch.o src/tools/feishu_tools.o src/tools/feishu_comment_rules.o src/tools/file_merge.o src/tools/mixture_of_agents.o src/tools/moa_performance.o src/tools/online_research.o src/tools/video_gen.o src/tools/video_gen_registry.o src/tools/video_analyze.o src/tools/image_gen_registry.o src/tools/web_search_registry.o src/tools/path_security.o src/tools/xai_http.o src/tools/account_usage.o src/agent/port_account_usage_remaining.o src/agent/port_billing_view_remaining.o src/tools/ansi_strip.o src/tools/transcribe.o \
    src/tools/transcribe_helpers.o \
src/tools/wecom_crypto.o src/tools/yuanbao_tools.o src/tools/yuanbao_media.o src/tools/media_cache.o src/sandbox_escape.o src/tools/env_probe.o src/tools/skills_guard.o src/tools/curator_backup.o src/tools/daytona.o src/tools/environment_gaps.o src/tools/image_gen_provider.o src/tools/tool_result_classification.o src/tools/tts_provider.o src/agent/port_tts_provider_remaining.o src/tools/tts_registry.o src/agent/port_tts_registry_remaining.o src/tools/video_gen_provider.o src/tools/binary_extensions.o src/tools/browser_camofox.o src/tools/managed_tool_gateway.o src/tools/microsoft_graph_auth.o src/tools/microsoft_graph_client.o src/tools/tool_backend_helpers.o src/tools/tool_output_limits.o src/tools/tool_search.o src/tools/checkpoint_manager.o src/tools/port_tools_async_delegation.o src/tools/port_base.o src/tools/cron_prompt_sanitize.o src/tools/port_cronjob_tools.o src/tools/file_text_ops.o src/tools/file_ops_lint.o src/tools/file_fs_ops.o src/tools/file_pagination_ops.o src/tools/port_file_tools_helpers.o src/tools/port_file_tools_remaining2.o src/tools/port_code_execution_tool_remaining.o src/tools/port_mcp_oauth_remaining.o src/tools/port_checkpoint_manager_remaining.o src/tools/port_tools_read_extract.o src/tools/browser_redact.o src/tools/browser_supervisor_redact.o src/tools/skill_manager_val.o src/tools/port_cua_backend_helpers.o src/tools/port_cua_backend_remaining2.o src/tools/port_kanban_tools.o src/tools/port_kanban_tools_remaining.o src/tools/port_transcription_tools_remaining.o src/tools/port_env_managed_modal_remaining.o src/gateway/server.o
GATEWAY_OBJ = src/gateway/server.o src/gateway/gw_pollers.o src/gateway/gw_notifier.o src/gateway/gw_format.o src/gateway/gw_thread.o src/gateway/gw_approval.o src/gateway/gw_logging.o src/gateway/gw_dispatch.o src/gateway/gw_session.o src/gateway/gw_setup.o src/gateway/gw_misc.o src/gateway/gateway_runtime.o src/gateway/config.o src/gateway/telegram_filter.o src/gateway/helpers.o src/gateway/run_pure.o src/gateway/shutdown_forensics.o src/gateway/sticker_cache.o src/gateway/mirror.o src/gateway/slash_access.o src/gateway/runtime_footer.o src/gateway/channel_directory.o src/gateway/gateway_gaps.o src/gateway/platforms/telegram.o src/gateway/platforms/telegram_network.o src/gateway/platforms/discord.o src/gateway/platforms/webhook.o src/gateway/platforms/slack.o src/gateway/platforms/matrix.o src/gateway/platforms/mattermost.o src/gateway/platforms/whatsapp.o src/gateway/platforms/email.o src/gateway/platforms/signal.o src/gateway/platforms/homeassistant.o src/gateway/platforms/sms.o src/gateway/platforms/feishu.o src/gateway/platforms/wecom.o src/gateway/platforms/wecom_callback.o src/gateway/platforms/dingtalk.o src/gateway/platforms/qqbot.o src/gateway/platforms/bluebubbles.o src/gateway/platforms/msgraph_webhook.o src/gateway/port_msgraph_webhook_remaining.o src/gateway/port_platform_registry_remaining.o src/gateway/platforms/msgraph_webhook_security.o src/gateway/platforms/weixin.o src/gateway/platforms/yuanbao.o src/gateway/platforms/base.o src/gateway/platforms/base_ext.o src/gateway/platforms/base_ext2.o src/gateway/platforms/base_adapter.o src/gateway/platforms/api_server_adapter.o src/gateway/platforms/api_server_adapter_handlers.o src/gateway/platforms/api_server_adapter_sessions.o src/gateway/platforms/api_server_adapter_chat.o src/gateway/platforms/api_server_adapter_responses.o src/gateway/platforms/api_server_adapter_runs.o src/gateway/platforms/api_server_adapter_cron.o src/gateway/platforms/feishu_comment_rules.o src/gateway/platforms/signal_rate_limit.o src/gateway/platforms/feishu_comment.o src/gateway/platforms/yuanbao_proto.o src/gateway/port_yuanbao_proto_remaining.o src/gateway/platforms/yuanbao_media.o src/gateway/platforms/yuanbao_sticker.o src/gateway/gateway_lifecycle.o src/gateway/stream_events.o src/gateway/delivery.o src/gateway/display_config.o src/gateway/memory_monitor.o src/gateway/pairing.o src/gateway/restart.o src/gateway/run.o src/gateway/session.o src/gateway/session_context.o src/gateway/stream_consumer.o src/gateway/whatsapp_identity.o src/gateway/port_whatsapp_identity_remaining.o src/gateway/port_gateway_message_timestamps.o src/gateway/port_gateway_platforms_api_server.o src/gateway/port_gateway_platforms_base.o src/gateway/port_platforms_base.o src/gateway/port_platforms_base_remaining2.o src/gateway/port_platforms_base_remaining3.o src/gateway/port_platforms_helpers_remaining.o src/gateway/port_turn_lease_remaining.o src/gateway/port_message_timestamps_remaining.o src/gateway/port_qqbot_chunked_upload_remaining.o src/gateway/port_signal_rate_limit_remaining.o src/gateway/port_gateway_relay_adapter.o src/gateway/port_gateway_relay_auth.o src/gateway/port_relay_auth_remaining2.o src/gateway/port_relay_transport_remaining.o src/gateway/port_gateway_relay_descriptor.o src/gateway/port_gateway_relay_transport.o src/gateway/port_gateway_relay_ws_transport.o src/gateway/port_gateway_rich_sent_store.o src/gateway/port_gateway_code_skew.o src/gateway/port_code_skew_remaining.o src/gateway/port_gateway_authz_mixin.o src/gateway/restart_loop_guard.o src/gateway/dead_targets.o src/gateway/platforms/http_client_limits.o \
 src/gateway/port_gateway_platforms_base_media.o src/gateway/status.o
AGENT_PORT_NEW = src/agent/port_agent_redact_helpers.o src/agent/port_agent_tool_dispatch_helpers.o src/agent/port_agent_verify_hooks.o src/agent/port_agent_ssl_verify.o src/agent/port_agent_turn_context.o src/agent/port_billing_links.o src/agent/port_billing_usage.o src/agent/port_battery.o src/agent/port_aux_accounting.o src/agent/port_auxiliary_client.o src/agent/port_async_utils.o src/agent/hermes_state/hermes_state_open.o src/agent/hermes_state/hermes_state_lifecycle.o src/agent/hermes_state/hermes_state_messages.o src/agent/hermes_state/hermes_state_lineage.o src/agent/hermes_state/hermes_state_tokens.o src/agent/hermes_state/hermes_state_archive.o src/agent/hermes_state/hermes_state_misc.o src/agent/hermes_state/hermes_state_repair.o src/agent/hermes_state/hermes_state_locks.o src/agent/hermes_state/port_hermes_state_remaining.o src/agent/port_iron_proxy.o src/agent/port_iron_proxy_remaining.o src/agent/port_bitwarden_remaining.o src/agent/port_secret_sources_helpers.o src/agent/port_lsp_servers.o src/agent/port_lsp_servers_remaining.o src/agent/port_lsp_client_remaining.o src/agent/port_lsp_eventlog.o src/agent/port_lsp_eventlog_remaining.o src/agent/port_lsp_init_remaining.o src/agent/conversation_compression_helpers.o src/cli/session_recovery/session_recovery_paths.o src/cli/session_recovery/session_recovery_preflight.o src/cli/session_recovery/session_recovery_copy.o src/cli/session_recovery/session_recovery_salvage.o src/cli/session_recovery/session_recovery_meta.o src/cli/session_recovery/session_recovery_orphans.o src/cli/session_recovery/session_recovery_verify.o src/cli/session_recovery/session_recovery_main.o src/agent/port_agent_coding_context.o src/agent/port_agent_background_review.o src/agent/port_antigravity_oauth.o
TOOLS_PORT_NEW = src/tools/port_file_operations_search.o src/tools/port_tools_slash_confirm.o src/tools/port_interrupt.o src/cli/port_moa_pure_helpers.o src/cli/port_config_py_pure.o src/cli/port_config_py_io.o src/cli/port_models_py_helpers.o src/tools/port_research_helpers.o src/cli/port_moa_config_pure.o src/cli/port_moa_slash.o src/cli/port_input_sanitize.o src/cli/port_utils_truthy.o src/cli/port_session_title.o src/cli/port_state_usage_db.o src/tools/port_toolsets.o src/cli/port_platform_tools.o src/tools/port_browser_tool.o src/tools/port_budget_config.o src/tools/port_clarify_tool.o src/tools/port_feishu_drive_tool.o src/tools/port_feishu_drive_tool_remaining.o src/tools/port_feishu_doc_tool_remaining.o src/tools/port_debug_helpers_remaining.o src/tools/port_env_local_remaining.o src/tools/port_terminal_tool_remaining.o src/tools/port_env_ssh_remaining.o src/tools/port_mcp_oauth_manager_remaining.o src/tools/port_microsoft_graph_client_remaining.o src/tools/port_session_search_tool.o src/tools/port_write_approval.o
GATEWAY_PORT_NEW = src/cli/port_gateway_platforms_helpers.o src/gateway/port_gateway_platforms_helpers.o src/gateway/port_gateway_drain_control.o src/gateway/run_pure2.o src/gateway/port_slash_command_guards.o src/gateway/port_gateway_run_deps.o src/gateway/port_slash_commands.o src/gateway/port_gateway_run_wrappers.o src/gateway/port_api_server_wrappers.o src/gateway/port_api_server_remaining.o src/gateway/port_qqbot_wrappers.o src/gateway/port_yuanbao_wrappers.o src/gateway/port_yuanbao_remaining.o src/gateway/port_weixin_wrappers.o src/gateway/port_weixin_remaining.o src/gateway/port_signal_remaining.o src/gateway/port_signal_remaining2.o src/gateway/port_api_server_remaining.o src/gateway/port_session_remaining2.o src/gateway/port_relay_init_remaining.o src/gateway/port_gateway_config_remaining.o src/gateway/port_gateway_config_remaining2.o src/gateway/port_relay_ws_transport_remaining.o src/gateway/port_gateway_session_remaining.o src/gateway/port_session_context_remaining.o src/gateway/port_gateway_status_remaining.o src/gateway/port_qqbot_adapter_remaining.o src/gateway/port_whatsapp_cloud_remaining.o src/gateway/port_shutdown_watchdog_remaining.o src/gateway/port_stream_dispatch_remaining.o src/gateway/port_relay_adapter_remaining.o src/gateway/port_bluebubbles_remaining.o src/gateway/port_systemd_notify_remaining.o src/gateway/port_yuanbao_media_remaining.o src/gateway/port_qqbot_keyboards_remaining.o src/gateway/port_gateway_run_remaining.o src/gateway/port_webhook_remaining.o src/gateway/port_gateway_remaining_gaps.o src/gateway/port_status_wrappers.o src/gateway/port_bluebubbles_wrappers.o src/gateway/port_gateway_remaining_wrappers.o src/gateway/port_hermes_constants_reasoning.o src/gateway/port_gateway_run_agent.o src/cli/port_provider_registry.o
AGENT_PORT_REGEN = src/agent/port_agent_reasoning_timeouts.o src/agent/port_agent_replay_cleanup.o src/agent/port_agent_retry_utils.o src/agent/port_agent_thinking_timeout_guidance.o src/agent/port_agent_intent_ack.o src/agent/port_agent_display_helpers.o src/agent/port_markdown_tables.o src/agent/port_agent_auxiliary_client_helpers.o src/agent/port_agent_auxiliary_client_runtime.o src/agent/port_moa_trace_helpers.o src/agent/port_lsp_range_shift.o src/agent/transport_common.o src/agent/secret_common.o src/agent/lsp_protocol.o src/agent/lsp_client.o src/agent/lsp_manager.o src/agent/provider_profile.o src/agent/provider_profiles_builtin.o src/agent/provider_profile_apply.o src/agent/port_agent_delegation_context.o src/agent/port_agent_reactions.o src/cli/port_plugins_wrappers.o src/cli/port_plugins_cmd_wrappers.o src/cli/port_cli_commands_mixin_wrappers.o src/cli/port_commands_wrappers.o src/cli/port_web_server_wrappers.o src/cli/port_main_wrappers.o src/cli/port_main_remaining.o src/cli/port_utils_remaining.o src/cli/port_kanban_db_remaining.o src/cli/port_cli_billing_mixin_remaining.o src/cli/port_auth_remaining2.o src/cli/port_gateway_cli_remaining.o src/cli/port_web_server_remaining2.o src/cli/port_pty_session_remaining.o src/cli/port_plugins_remaining.o src/cli/port_auth_wrappers.o src/cli/port_tools_config_wrappers.o src/cli/port_cli_gateway_wrappers.o src/cli/port_console_engine_wrappers.o src/cli/port_gateway_windows_wrappers.o src/cli/port_kanban_wrappers.o src/cli/port_setup_wrappers.o src/cli/port_setup_remaining.o src/cli/port_kanban_db_wrappers.o src/cli/port_managed_uv_wrappers.o src/cli/port_windows_ssh_wrappers.o src/agent/port_moa_loop_wrappers.o src/agent/port_memory_manager_wrappers.o src/cli/port_model_setup_wrappers.o src/cli/port_nous_account_wrappers.o src/cli/port_session_export_wrappers.o src/cli/port_uninstall_wrappers.o src/cli/port_model_switch_wrappers.o src/cli/port_session_export_md_wrappers.o src/cli/port_nous_sub_wrappers.o src/cli/port_runtime_provider_wrappers.o src/cli/port_cli_wrappers.o src/agent/port_skill_utils_wrappers.o src/agent/port_context_compressor_wrappers.o src/agent/port_context_compressor_remaining.o src/agent/port_verif_evidence_wrappers.o src/cli/port_cli_remaining_wrappers.o src/cli/port_other_remaining_wrappers.o src/cli/port_cli_remaining2.o src/cli/port_cli_remaining3.o src/cli/port_config_remaining.o src/agent/port_agent_remaining_wrappers.o src/agent/port_agent_remaining_gaps.o src/cli/port_hermes_cli_remaining_gaps.o $(AGENT_PORT_NEW)
...
TOOLS_PORT_REGEN = src/tools/port_url_safety_helpers.o src/tools/port_patch_parser.o src/cli/port_tools_schema_sanitizer.o src/tools/port_tools_slash_confirm.o src/cli/port_hermes_cli_migrate.o src/tools/port_skills_sync.o src/tools/port_skills_sync_remaining.o src/cli/port_cli_pet_input.o src/tools/port_browser_tool_helpers.o src/tools/port_web_tools.o src/tools/skill_prereqs.o src/tools/port_skill_usage_wrappers.o src/tools/port_transcription_wrappers.o src/tools/port_vision_wrappers.o src/tools/port_file_tools_wrappers.o src/tools/port_cua_backend_wrappers.o src/tools/port_env_local_wrappers.o src/tools/port_mcp_oauth_wrappers.o src/tools/port_async_delegation_wrappers.o src/tools/port_terminal_tool_wrappers.o src/tools/port_env_base_wrappers.o src/tools/port_env_docker_wrappers.o src/tools/port_skill_mgr_tool_wrappers.o src/tools/port_memory_tool_wrappers.o src/tools/port_approval_wrappers.o src/tools/port_tools_remaining_wrappers.o src/tools/port_skills_tool.o src/tools/port_skills_tool_remaining.o src/tools/port_file_state_remaining.o src/tools/port_online_research_remaining.o src/tools/port_tools_remaining_gaps.o $(TOOLS_PORT_NEW)
...
CRON_OBJ = src/cron/scheduler.o src/cron/jobs.o src/cron/cron_extras.o src/cron/cron_sqlite.o src/cron/port_scheduler_provider_remaining.o src/cron/port_cron_scheduler_remaining.o src/cron/cron_cli.o src/cron/port_cron_scheduler_provider.o src/cron/port_cron_scheduler_helpers.o src/cron/port_cron_scheduler_delivery.o src/cron/port_cron_scheduler_runtime.o src/cron/port_cron_scheduler_runtime_impl.o src/cron/port_cron_scheduler_toolsets.o src/cron/port_cron_scheduler_script.o src/cron/port_cron_scheduler_prompt.o src/cron/port_scheduler.o src/cron/cron_suggestions.o src/cron/suggestion_catalog.o src/cron/port_jobs.o src/cron/port_lifecycle_guard.o src/cron/port_cron_jobs.o src/cron/port_classify_items.o
