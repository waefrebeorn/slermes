...
AGENT_PORT_NEW = src/agent/port_agent_redact_helpers.o src/agent/port_agent_tool_dispatch_helpers.o src/agent/port_agent_verify_hooks.o src/agent/port_agent_ssl_verify.o src/agent/port_agent_turn_context.o src/agent/port_billing_links.o src/agent/port_billing_usage.o src/agent/port_battery.o src/agent/port_aux_accounting.o src/agent/port_auxiliary_client.o src/agent/port_async_utils.o src/agent/hermes_state/hermes_state_open.o src/agent/hermes_state/hermes_state_lifecycle.o src/agent/hermes_state/hermes_state_messages.o src/agent/hermes_state/hermes_state_lineage.o src/agent/hermes_state/hermes_state_tokens.o src/agent/hermes_state/hermes_state_archive.o src/agent/hermes_state/hermes_state_misc.o src/agent/hermes_state/hermes_state_repair.o src/agent/hermes_state/hermes_state_locks.o src/agent/hermes_state/port_hermes_state_remaining.o src/agent/port_iron_proxy.o src/agent/port_iron_proxy_remaining.o src/agent/port_secret_sources_helpers.o src/agent/port_lsp_servers.o src/agent/port_lsp_servers_remaining.o src/agent/port_lsp_eventlog.o src/agent/conversation_compression_helpers.o src/cli/session_recovery/session_recovery_paths.o src/cli/session_recovery/session_recovery_preflight.o src/cli/session_recovery/session_recovery_copy.o src/cli/session_recovery/session_recovery_salvage.o src/cli/session_recovery/session_recovery_meta.o src/cli/session_recovery/session_recovery_orphans.o src/cli/session_recovery/session_recovery_verify.o src/cli/session_recovery/session_recovery_main.o src/agent/port_agent_coding_context.o src/agent/port_agent_background_review.o src/agent/port_antigravity_oauth.o
...
GATEWAY_PORT_NEW = src/cli/port_gateway_platforms_helpers.o src/gateway/port_gateway_platforms_helpers.o src/gateway/port_gateway_drain_control.o src/gateway/run_pure2.o src/gateway/port_slash_command_guards.o src/gateway/port_gateway_run_deps.o src/gateway/port_slash_commands.o src/gateway/port_gateway_run_wrappers.o src/gateway/port_api_server_wrappers.o src/gateway/port_api_server_remaining.o src/gateway/port_qqbot_wrappers.o src/gateway/port_yuanbao_wrappers.o src/gateway/port_weixin_wrappers.o src/gateway/port_status_wrappers.o src/gateway/port_bluebubbles_wrappers.o src/gateway/port_gateway_remaining_wrappers.o src/gateway/port_hermes_constants_reasoning.o src/gateway/port_gateway_run_agent.o src/cli/port_provider_registry.o
