...
GATEWAY_PORT_NEW = src/cli/port_gateway_platforms_helpers.o src/gateway/port_gateway_platforms_helpers.o src/gateway/port_gateway_drain_control.o src/gateway/run_pure2.o src/gateway/port_slash_command_guards.o src/gateway/port_gateway_run_deps.o src/gateway/port_slash_commands.o src/gateway/port_gateway_run_wrappers.o src/gateway/port_api_server_wrappers.o src/gateway/port_api_server_remaining.o src/gateway/port_qqbot_wrappers.o src/gateway/port_yuanbao_wrappers.o src/gateway/port_yuanbao_remaining.o src/gateway/port_weixin_wrappers.o src/gateway/port_weixin_remaining.o src/gateway/port_signal_remaining.o src/gateway/port_relay_init_remaining.o src/gateway/port_gateway_config_remaining.o src/gateway/port_relay_ws_transport_remaining.o src/gateway/port_gateway_session_remaining.o src/gateway/port_session_context_remaining.o src/gateway/port_gateway_status_remaining.o src/gateway/port_qqbot_adapter_remaining.o src/gateway/port_whatsapp_cloud_remaining.o src/gateway/port_shutdown_watchdog_remaining.o src/gateway/port_relay_adapter_remaining.o src/gateway/port_bluebubbles_remaining.o src/gateway/port_systemd_notify_remaining.o src/gateway/port_yuanbao_media_remaining.o src/gateway/port_qqbot_keyboards_remaining.o src/gateway/port_gateway_run_remaining.o src/gateway/port_webhook_remaining.o src/gateway/port_status_wrappers.o src/gateway/port_bluebubbles_wrappers.o src/gateway/port_gateway_remaining_wrappers.o src/gateway/port_hermes_constants_reasoning.o src/gateway/port_gateway_run_agent.o src/cli/port_provider_registry.o
