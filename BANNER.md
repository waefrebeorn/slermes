...
# ║                                                              ║
# ║  Build: Clean  │  v560 │  Tests: 36/36  │  Oracle: 23/0 + 22/0 + 22/0 + 12/0 + 4/0 + 16/0 + 21/0 + 25/0 + 4/0 + 1611/0 fuzz ║
...
# ║  ✓ v560: copilot_acp_client 2 pure struct-builders ported ║
# ║    (build_openai_tool_call + completion_to_stream_chunks); ║
# ║    oracle 4/0; copilot_acp_client.py REAL_GAP=0. managed_modal ║
# ║    _request_timeout_env already ported (scanner prefix false-pos). ║
