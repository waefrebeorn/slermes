/* AUTO-GENERATED integration oracle harness for port_learning_mutations (gen_integration_oracle.py). */
#include "hermes_core_types.h"
#include "hermes_json.h"
#include "port_learning_mutations.c"
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(int argc, char **argv){
    ...
    for (int i = 0; i < n; i++){
        ...
        json_t *o = NULL;
        if (strcmp(op, "learning_mutations_parse_node_kind") == 0) o = emit_learning_mutations_parse_node_kind(c);
