"""AUTO-GENERATED integration oracle for port_agent_anthropic_adapter (gen_integration_oracle.py)."""
...
DISPATCH = {
    'cli_agent_anthropic_adapter__supports_adaptive_thinking': ('agent.anthropic_adapter', '_supports_adaptive_thinking'),
    'cli_agent_anthropic_adapter__supports_xhigh_effort': ('agent.anthropic_adapter', '_supports_xhigh_effort'),
    'cli_agent_anthropic_adapter__forbids_sampling_params': ('agent.anthropic_adapter', '_forbids_sampling_params'),
    'cli_agent_anthropic_adapter__supports_fast_mode': ('agent.anthropic_adapter', '_supports_fast_mode'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_agent_anthropic_adapter.py <cases.json>\n"); return 2
