/* AUTO-GENERATED oracle harness for agent_prompt_builder (gen_oracle.py). */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include "prompt_builder.c"
...
int main(void){
  ...
  clear_backend_probe_cache();
  printf("{\"func\":\"skill_should_show\",\"ret\":0}\n", "skill_should_show", (int)skill_should_show());
  return 0;
}
