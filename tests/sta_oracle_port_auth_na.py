"""AUTO-GENERATED integration oracle for port_auth_na (gen_integration_oracle.py)."""
...
DISPATCH = {
    'coerce_ttl_seconds': ('hermes_cli.auth', '_coerce_ttl_seconds'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_auth_na.py <cases.json>\n"); return 2
