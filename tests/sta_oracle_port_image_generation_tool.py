"""AUTO-GENERATED integration oracle for port_image_generation_tool (gen_integration_oracle.py)."""
...
DISPATCH = {
    'image_gen_looks_like_absolute_file_path': ('tools.image_generation_tool', '_looks_like_absolute_file_path'),
    'image_gen_is_krea_model': ('tools.image_generation_tool', 'is_krea_model'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_image_generation_tool.py <cases.json>\n"); return 2
