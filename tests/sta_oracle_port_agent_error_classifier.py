"""AUTO-GENERATED integration oracle for port_agent_error_classifier (gen_integration_oracle.py)."""
...
DISPATCH = {
    'cli_agent_error_classifier_is_auth': ('agent.error_classifier', 'is_auth'),
    'cli_agent_error_classifier__extract_status_code': ('agent.error_classifier', '_extract_status_code'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_agent_error_classifier.py <cases.json>\n"); return 2
