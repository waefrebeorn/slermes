/* AUTO-GENERATED integration oracle harness for port_url_safety_helpers (gen_integration_oracle.py). */
...
static json_t *emit_tools_url_safety_has_sensitive_query_params(const json_t *c){
    const char *value = json_get_str(c, "value", "");
    int v = (int)tools_url_safety_has_sensitive_query_params(value);
    json_t *o = json_new_object(); json_set(o, "fn", json_string("tools_url_safety_has_sensitive_query_params"));
...
int main(int argc, char **argv){
    ...
    for (int i = 0; i < n; i++){
        ...
        json_t *o = NULL;
        if (strcmp(op, "tools_url_safety_has_sensitive_query_params") == 0) o = emit_tools_url_safety_has_sensitive_query_params(c);
