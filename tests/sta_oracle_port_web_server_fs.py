"""AUTO-GENERATED integration oracle for port_web_server_fs (gen_integration_oracle.py)."""
...
DISPATCH = {
    'ws_fs_readdir_hidden': ('hermes_cli.web_server', '_FS_READDIR_HIDDEN'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_web_server_fs.py <cases.json>\n"); return 2
