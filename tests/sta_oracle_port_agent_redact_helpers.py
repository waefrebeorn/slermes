"""AUTO-GENERATED integration oracle for port_agent_redact_helpers (gen_integration_oracle.py)."""
...
DISPATCH = {
    'agent_redact_is_env_dump_command': ('agent.redact', 'is_env_dump_command'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_agent_redact_helpers.py <cases.json>\n"); return 2
