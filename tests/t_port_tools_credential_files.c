/* AUTO-GENERATED oracle harness for tools_credential_files (gen_oracle.py). */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include "port_tools_credential_files.c"
...
int main(void){
  ...
  cli_tools_credential_files_clear_credential_files();
  return 0;
}
