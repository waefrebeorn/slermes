"""AUTO-GENERATED integration oracle for port_models_net (gen_integration_oracle.py)."""
...
DISPATCH = {
    'models_is_github_models_base_url': ('hermes_cli.models', '_is_github_models_base_url'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_models_net.py <cases.json>\n"); return 2
