/* AUTO-GENERATED oracle harness for hermes_cli_gateway (gen_oracle.py). */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include "port_gateway.c"
...
int main(void){
  ...
  printf("{\"func\":\"supports_systemd_services\",\"ret\":0}\n", "supports_systemd_services", (int)supports_systemd_services());
  return 0;
}
