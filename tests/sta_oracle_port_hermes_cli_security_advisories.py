"""AUTO-GENERATED integration oracle for port_hermes_cli_security_advisories (gen_integration_oracle.py)."""
...
def _load(rel):
    ...
    for base in sys.path:
        ...
        try:
            ...
            continue
    return None
MODS['hermes_cli.security_advisories'] = _load('hermes_cli/security_advisories.py')

DISPATCH = {
    'cli_security_advisories_ack_advisory': ('hermes_cli.security_advisories', 'ack_advisory'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_hermes_cli_security_advisories.py <cases.json>\n"); return 2
