"""AUTO-GENERATED oracle for tools_read_terminal_tool (gen_oracle.py)."""
import sys, json, os
...
for line in sys.stdin:
    ...
    fn = rec['func']
    ARGS = {
        'cli_tools_read_terminal_tool_check_read_terminal_requirements': ('check_read_terminal_requirements', []),
    }
    if fn not in ARGS:
        continue
    pyf, pargs = ARGS[fn]
