"""AUTO-GENERATED integration oracle for port_gateway_platforms_base_media (gen_integration_oracle.py)."""
...
DISPATCH = {
    'base_platform_path_under_denied_prefix': ('gateway.platforms.base', '_path_under_denied_prefix'),
    'base_platform_path_lacks_deliverable_extension': ('gateway.platforms.base', '_path_lacks_deliverable_extension'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_gateway_platforms_base_media.py <cases.json>\n"); return 2
