"""AUTO-GENERATED oracle for hermes_cli_moa_slash (gen_oracle.py)."""
import sys, json, os
sys.path.insert(0, os.path.expanduser("~/hermes-agent-dev"))
from hermes_cli.moa_slash import (register_moa_slash_handler)
...
for line in sys.stdin:
    ...
    fn = rec['func']
    ARGS = {
        'moa_gateway_register_slash_handler': ('register_moa_slash_handler', []),
    }
    if fn not in ARGS:
        continue
    pyf, pargs = ARGS[fn]
