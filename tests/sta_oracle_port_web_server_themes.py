"""AUTO-GENERATED integration oracle for port_web_server_themes (gen_integration_oracle.py)."""
...
DISPATCH = {
    'ws_theme_font_choice_allowed': ('hermes_cli.web_server', 'set_dashboard_font'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_web_server_themes.py <cases.json>\n"); return 2
