"""AUTO-GENERATED integration oracle for port_cron_scheduler_delivery (gen_integration_oracle.py)."""
...
DISPATCH = {
    'scheduler_is_known_delivery_platform': ('cron.scheduler', '_is_known_delivery_platform'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_cron_scheduler_delivery.py <cases.json>\n"); return 2
