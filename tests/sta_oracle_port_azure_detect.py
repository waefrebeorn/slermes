"""AUTO-GENERATED integration oracle for port_azure_detect (gen_integration_oracle.py)."""
...
DISPATCH = {
    'azure_looks_like_anthropic_path': ('hermes_cli.azure_detect', '_looks_like_anthropic_path'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_azure_detect.py <cases.json>\n"); return 2
