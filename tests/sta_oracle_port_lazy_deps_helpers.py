"""AUTO-GENERATED integration oracle for port_lazy_deps_helpers (gen_integration_oracle.py)."""
...
DISPATCH = {
    'lazy_deps_spec_is_safe': ('tools.lazy_deps', '_spec_is_safe'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_lazy_deps_helpers.py <cases.json>\n"); return 2
