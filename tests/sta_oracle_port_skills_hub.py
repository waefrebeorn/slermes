"""AUTO-GENERATED integration oracle for port_skills_hub (gen_integration_oracle.py)."""
...
DISPATCH = {
    'skills_hub_is_valid_skill_name': ('tools.skills_hub', '_is_valid_skill_name'),
    'skills_hub_ensure_dir': ('tools.skills_hub', '_ensure_dir'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_skills_hub.py <cases.json>\n"); return 2
