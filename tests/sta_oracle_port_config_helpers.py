"""AUTO-GENERATED integration oracle for port_config_helpers (gen_integration_oracle.py)."""
...
DISPATCH = {
    'is_env_config_key': ('hermes_cli.config', '_is_env_config_key'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_config_helpers.py <cases.json>\n"); return 2
