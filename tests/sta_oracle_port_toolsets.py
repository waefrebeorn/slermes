"""AUTO-GENERATED integration oracle for port_toolsets (gen_integration_oracle.py)."""
...
def _load(rel):
    ...
    for base in sys.path:
        ...
        try:
            ...
            continue
    return None
MODS['toolsets'] = _load('toolsets.py')

DISPATCH = {
    'toolsets_validate': ('toolsets', 'validate_toolset'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_toolsets.py <cases.json>\n"); return 2
