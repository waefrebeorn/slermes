"""AUTO-GENERATED integration oracle for port_agent_auxiliary_client_runtime (gen_integration_oracle.py)."""
...
DISPATCH = {
    'aux__client_streams_internally': ('agent.auxiliary_client', '_client_streams_internally'),
    'aux__is_streaming_rejected_error': ('agent.auxiliary_client', '_is_streaming_rejected_error'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_agent_auxiliary_client_runtime.py <cases.json>\n"); return 2
