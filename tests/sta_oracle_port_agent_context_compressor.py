"""AUTO-GENERATED integration oracle for port_agent_context_compressor (gen_integration_oracle.py)."""
...
DISPATCH = {
    'cli_agent_context_compressor__is_context_summary_content': ('agent.context_compressor', '_is_context_summary_content'),
    'cli_agent_context_compressor__has_compressed_summary_metadata': ('agent.context_compressor', '_has_compressed_summary_metadata'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_agent_context_compressor.py <cases.json>\n"); return 2
