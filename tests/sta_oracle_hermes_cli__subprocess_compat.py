"""AUTO-GENERATED oracle for hermes_cli__subprocess_compat (gen_oracle.py)."""
import sys, json, os
...
for line in sys.stdin:
    ...
    fn = rec['func']
    ARGS = {
        'cli_pt_input_extras_install_ignored_terminal_sequences': ('install_ignored_terminal_sequences', []),
    }
    if fn not in ARGS:
        continue
    pyf, pargs = ARGS[fn]
