"""AUTO-GENERATED integration oracle for port_url_safety_helpers (gen_integration_oracle.py)."""
...
DISPATCH = {
    'tools_url_safety_has_sensitive_query_params': ('tools.url_safety', '_allows_private_ip_resolution'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_url_safety_helpers.py <cases.json>\n"); return 2
