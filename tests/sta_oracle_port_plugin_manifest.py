"""AUTO-GENERATED integration oracle for port_plugin_manifest (gen_integration_oracle.py)."""
...
DISPATCH = {
    'plugin_manifest_kind_is_valid': ('hermes_cli.plugins', '_VALID_PLUGIN_KINDS'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_plugin_manifest.py <cases.json>\n"); return 2
