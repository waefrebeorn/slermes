"""AUTO-GENERATED integration oracle for port_tools_tool_search (gen_integration_oracle.py)."""
...
DISPATCH = {
    'cli_tools_tool_search_is_bridge_tool': ('tools.tool_search', 'is_bridge_tool'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_tools_tool_search.py <cases.json>\n"); return 2
