"""AUTO-GENERATED integration oracle for port_agent_ssl_verify (gen_integration_oracle.py)."""
...
def _load(rel):
    ...
    for base in sys.path:
        ...
        try:
            ...
            continue
    return None
MODS['agent.ssl_verify'] = _load('agent/ssl_verify.py')

DISPATCH = {
    'agent_ssl_verify_coerce_insecure': ('agent.ssl_verify', '_coerce_insecure'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_agent_ssl_verify.py <cases.json>\n"); return 2
