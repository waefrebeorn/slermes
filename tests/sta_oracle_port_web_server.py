"""AUTO-GENERATED integration oracle for port_web_server (gen_integration_oracle.py)."""
...
DISPATCH = {
    'web_validate_plugin_name': ('hermes_cli.web_server', '_validate_plugin_name'),
    'web_maybe_open_browser': ('hermes_cli.web_server', '_maybe_open_browser'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_web_server.py <cases.json>\n"); return 2
