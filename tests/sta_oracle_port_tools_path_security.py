"""AUTO-GENERATED integration oracle for port_tools_path_security (gen_integration_oracle.py)."""
...
def _load(rel):
    ...
    for base in sys.path:
        ...
        try:
            ...
            continue
    return None
MODS['tools.path_security'] = _load('tools/path_security.py')

DISPATCH = {
    'cli_tools_path_security_has_traversal_component': ('tools.path_security', 'has_traversal_component'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_tools_path_security.py <cases.json>\n"); return 2
