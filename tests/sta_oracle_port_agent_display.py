"""AUTO-GENERATED integration oracle for port_agent_display (gen_integration_oracle.py)."""
...
DISPATCH = {
    'cli_agent_display__is_shell_boundary_echo': ('agent.display', '_is_shell_boundary_echo'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_agent_display.py <cases.json>\n"); return 2
