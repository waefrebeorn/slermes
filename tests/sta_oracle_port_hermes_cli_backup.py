"""AUTO-GENERATED integration oracle for port_hermes_cli_backup (gen_integration_oracle.py)."""
...
DISPATCH = {
    'backup_should_exclude': ('hermes_cli.backup', '_should_exclude'),
    'backup_count_cron_jobs': ('hermes_cli.backup', '_count_cron_jobs'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_hermes_cli_backup.py <cases.json>\n"); return 2
