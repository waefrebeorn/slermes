"""AUTO-GENERATED integration oracle for port_doctor (gen_integration_oracle.py)."""
...
DISPATCH = {
    'doctor_has_provider_env_config': ('hermes_cli.doctor', '_has_provider_env_config'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_doctor.py <cases.json>\n"); return 2
