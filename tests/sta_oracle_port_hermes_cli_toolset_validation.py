"""AUTO-GENERATED integration oracle for port_hermes_cli_toolset_validation (gen_integration_oracle.py)."""
...
def _load(rel):
    ...
    for base in sys.path:
        ...
        try:
            ...
            continue
    return None
MODS['hermes_cli.toolset_validation'] = _load('hermes_cli/toolset_validation.py')

DISPATCH = {
    'toolset_validation_is_known_toolset': ('hermes_cli.toolset_validation', 'validate_toolset'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_hermes_cli_toolset_validation.py <cases.json>\n"); return 2
