/* AUTO-GENERATED oracle harness for tools_microsoft_graph_auth (gen_oracle.py). */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include "port_tools_microsoft_graph_auth.c"
...
int main(void){
  ...
  cli_tools_microsoft_graph_auth_clear_cache();
  return 0;
}
