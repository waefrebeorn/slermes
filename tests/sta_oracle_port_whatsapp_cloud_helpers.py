"""AUTO-GENERATED integration oracle for port_whatsapp_cloud_helpers (gen_integration_oracle.py)."""
...
def _load(rel):
    ...
    for base in sys.path:
        ...
        try:
            ...
            continue
    return None
MODS['gateway.platforms.whatsapp_cloud'] = _load('gateway/platforms/whatsapp_cloud.py')

DISPATCH = {
    'whatsapp_cloud_dedup_wamid': ('gateway.platforms.whatsapp_cloud', '_dedup_wamid'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_whatsapp_cloud_helpers.py <cases.json>\n"); return 2
