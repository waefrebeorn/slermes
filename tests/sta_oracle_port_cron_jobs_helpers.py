"""AUTO-GENERATED integration oracle for port_cron_jobs_helpers (gen_integration_oracle.py)."""
...
DISPATCH = {
    'jobs_parse_duration': ('cron.jobs', 'parse_duration'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_cron_jobs_helpers.py <cases.json>\n"); return 2
