"""AUTO-GENERATED integration oracle for port_tools_clarify_gateway (gen_integration_oracle.py)."""
...
DISPATCH = {
    'cli_tools_clarify_gateway_mark_awaiting_text': ('tools.clarify_gateway', 'mark_awaiting_text'),
    'cli_tools_clarify_gateway_has_pending': ('tools.clarify_gateway', 'has_pending'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_tools_clarify_gateway.py <cases.json>\n"); return 2
