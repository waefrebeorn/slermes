"""AUTO-GENERATED integration oracle for port_default_soul (gen_integration_oracle.py)."""
...
def _load(rel):
    ...
    for base in sys.path:
        ...
        try:
            ...
            continue
    return None
MODS['hermes_cli.default_soul'] = _load('hermes_cli/default_soul.py')

DISPATCH = {
    'hermes_cli_default_soul_is_legacy': ('hermes_cli.default_soul', 'is_legacy_template_soul'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_default_soul.py <cases.json>\n"); return 2
