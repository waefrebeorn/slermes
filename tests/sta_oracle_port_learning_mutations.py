"""AUTO-GENERATED integration oracle for port_learning_mutations (gen_integration_oracle.py)."""
...
def _load(rel):
    ...
    for base in sys.path:
        ...
        try:
            ...
            continue
    return None
MODS['agent.learning_mutations'] = _load('agent/learning_mutations.py')

DISPATCH = {
    'learning_mutations_parse_node_kind': ('agent.learning_mutations', 'parse_node_kind'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_learning_mutations.py <cases.json>\n"); return 2
