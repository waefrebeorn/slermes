"""AUTO-GENERATED integration oracle for port_gateway_platforms_feishu_meeting_invite (gen_integration_oracle.py)."""
...
def _load(rel):
    ...
    for base in sys.path:
        ...
        try:
            ...
            continue
    return None
MODS['gateway.platforms.feishu_meeting_invite'] = _load('gateway/platforms/feishu_meeting_invite.py')

DISPATCH = {
    'cli_gateway_platforms_feishu_meeting_invite__int_field': ('gateway.platforms.feishu_meeting_invite', '_int_field'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_gateway_platforms_feishu_meeting_invite.py <cases.json>\n"); return 2
