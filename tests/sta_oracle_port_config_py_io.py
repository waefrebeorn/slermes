"""AUTO-GENERATED integration oracle for port_config_py_io (gen_integration_oracle.py)."""
...
DISPATCH = {
    'config_py_ensure_hermes_home_managed': ('hermes_cli.config', '_ensure_hermes_home_managed'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_config_py_io.py <cases.json>\n"); return 2
