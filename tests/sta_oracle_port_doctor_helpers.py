"""AUTO-GENERATED integration oracle for port_doctor_helpers (gen_integration_oracle.py)."""
...
def _load(rel):
    ...
    for base in sys.path:
        ...
        try:
            ...
            continue
    return None
MODS['hermes_cli.doctor'] = _load('hermes_cli/doctor.py')

DISPATCH = {
    'doctor_has_healthy_oauth_fallback': ('hermes_cli.doctor', '_has_healthy_oauth_fallback_for_apikey_provider'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_doctor_helpers.py <cases.json>\n"); return 2
