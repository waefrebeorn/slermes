"""AUTO-GENERATED integration oracle for port_tools_website_policy (gen_integration_oracle.py)."""
...
DISPATCH = {
    'cli_tools_website_policy_load_website_blocklist': ('tools.website_policy', 'load_website_blocklist'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_tools_website_policy.py <cases.json>\n"); return 2
