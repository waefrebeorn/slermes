"""AUTO-GENERATED integration oracle for port_dashboard_auth_cookies (gen_integration_oracle.py)."""
...
DISPATCH = {
    'dash_detect_https': ('hermes_cli.dashboard_auth.cookies', 'detect_https'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_dashboard_auth_cookies.py <cases.json>\n"); return 2
