"""AUTO-GENERATED integration oracle for port_web_server_sessions_admin (gen_integration_oracle.py)."""
...
def _load(rel):
    ...
    for base in sys.path:
        ...
        try:
            ...
            continue
    return None
MODS['hermes_state'] = _load('hermes_state.py')

DISPATCH = {
    'ws_sessions_count_empty': ('hermes_state', 'count_empty_sessions'),
    'ws_sessions_delete_empty': ('hermes_state', 'delete_empty_sessions'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_web_server_sessions_admin.py <cases.json>\n"); return 2
