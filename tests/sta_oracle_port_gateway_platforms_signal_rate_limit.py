"""AUTO-GENERATED integration oracle for port_gateway_platforms_signal_rate_limit (gen_integration_oracle.py)."""
...
def _load(rel):
    ...
    for base in sys.path:
        ...
        try:
            ...
            continue
    return None
MODS['gateway.platforms.signal_rate_limit'] = _load('gateway/platforms/signal_rate_limit.py')

DISPATCH = {
    'cli_gateway_platforms_signal_rate_limit__extract_retry_after_seconds': ('gateway.platforms.signal_rate_limit', '_extract_retry_after_seconds'),
    'cli_gateway_platforms_signal_rate_limit__is_signal_rate_limit_error': ('gateway.platforms.signal_rate_limit', '_is_signal_rate_limit_error'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_gateway_platforms_signal_rate_limit.py <cases.json>\n"); return 2
