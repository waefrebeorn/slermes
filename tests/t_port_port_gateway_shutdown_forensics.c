/* AUTO-GENERATED integration oracle harness for port_gateway_shutdown_forensics (gen_integration_oracle.py). */
#include "hermes_core_types.h"
#include "hermes_json.h"
#include "port_gateway_shutdown_forensics.c"
#include <stdio.h>
#include <stdlib.h>
#include <string.h>

extern long cli_gateway_shutdown_forensics__parse_systemd_duration_to_us(const char *);
...
static json_t *emit_cli_gateway_shutdown_forensics__parse_systemd_duration_to_us(const json_t *c){
...
int main(int argc, char **argv){
    ...
    for (int i = 0; i < n; i++){
        ...
        json_t *o = NULL;
        if (strcmp(op, "cli_gateway_shutdown_forensics__parse_systemd_duration_to_us") == 0) o = emit_cli_gateway_shutdown_forensics__parse_systemd_duration_to_us(c);
