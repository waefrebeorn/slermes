"""AUTO-GENERATED integration oracle for port_cron_scheduler_script (gen_integration_oracle.py)."""
...
DISPATCH = {
    'scheduler_parse_wake_gate': ('cron.scheduler', '_parse_wake_gate'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_cron_scheduler_script.py <cases.json>\n"); return 2
