"""AUTO-GENERATED integration oracle for port_tts_tool (gen_integration_oracle.py)."""
...
def _load(rel):
    ...
    for base in sys.path:
        ...
        try:
            ...
            continue
    return None
MODS['tools.tts_tool'] = _load('tools/tts_tool.py')

DISPATCH = {
    'tts_tool_is_command_provider_config': ('tools.tts_tool', '_is_command_provider_config'),
    'tts_tool_get_command_tts_timeout': ('tools.tts_tool', '_get_command_tts_timeout'),
    'tts_tool_stream_tts_to_speaker': ('tools.tts_tool', 'stream_tts_to_speaker'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_tts_tool.py <cases.json>\n"); return 2
