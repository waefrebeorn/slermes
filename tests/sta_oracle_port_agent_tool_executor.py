"""AUTO-GENERATED integration oracle for port_agent_tool_executor (gen_integration_oracle.py)."""
...
DISPATCH = {
    'agent_tool_executor__is_interpreter_shutdown_submit_error': ('agent.tool_executor', '_is_interpreter_shutdown_submit_error'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_agent_tool_executor.py <cases.json>\n"); return 2
