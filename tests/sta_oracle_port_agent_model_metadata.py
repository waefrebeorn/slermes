"""AUTO-GENERATED integration oracle for port_agent_model_metadata (gen_integration_oracle.py)."""
...
DISPATCH = {
    'cli_agent_model_metadata__model_metadata_disk_cache_age_seconds': ('agent.model_metadata', '_model_metadata_disk_cache_age_seconds'),
    'cli_agent_model_metadata_is_output_cap_error': ('agent.model_metadata', 'is_output_cap_error'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_agent_model_metadata.py <cases.json>\n"); return 2
