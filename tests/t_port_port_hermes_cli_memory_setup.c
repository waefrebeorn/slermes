/* AUTO-GENERATED integration oracle harness for port_hermes_cli_memory_setup (gen_integration_oracle.py). */
#include "hermes_core_types.h"
#include "hermes_json.h"
#include "port_hermes_cli_memory_setup.c"
#include <stdio.h>
#include <stdlib.h>
#include <string.h>

extern int cli_hermes_cli_memory_setup__install_dependencies(const char *);
...
static json_t *emit_cli_hermes_cli_memory_setup__install_dependencies(const json_t *c){
...
int main(int argc, char **argv){
    ...
    for (int i = 0; i < n; i++){
        ...
        json_t *o = NULL;
        if (strcmp(op, "cli_hermes_cli_memory_setup__install_dependencies") == 0) o = emit_cli_hermes_cli_memory_setup__install_dependencies(c);
