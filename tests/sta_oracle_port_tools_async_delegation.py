"""AUTO-GENERATED integration oracle for port_tools_async_delegation (gen_integration_oracle.py)."""
...
DISPATCH = {
    'async_delegation_interrupt_all': ('tools.image_source', '_finalize'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_tools_async_delegation.py <cases.json>\n"); return 2
