"""AUTO-GENERATED integration oracle for port_hermes_cli_prompt_size (gen_integration_oracle.py)."""
...
def _load(rel):
    ...
    for base in sys.path:
        ...
        try:
            ...
            continue
    return None
MODS['hermes_cli.prompt_size'] = _load('hermes_cli/prompt_size.py')

DISPATCH = {
    'cli_hermes_cli_prompt_size__bytes': ('hermes_cli.prompt_size', '_bytes'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_hermes_cli_prompt_size.py <cases.json>\n"); return 2
