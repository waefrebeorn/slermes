"""AUTO-GENERATED integration oracle for port_gateway_run_deps (gen_integration_oracle.py)."""
...
DISPATCH = {
    'gw_goal_still_active_for_session': ('gateway.run', '_goal_still_active_for_session'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_gateway_run_deps.py <cases.json>\n"); return 2
