/* AUTO-GENERATED oracle harness for tools_skills_sync (gen_oracle.py). */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include "port_skills_sync.c"
...
int main(void){
  ...
  printf("{\"func\":\"is_bundled_skills_opt_out\",\"ret\":0}\n", "is_bundled_skills_opt_out", (int)is_bundled_skills_opt_out());
  return 0;
}
