...
class ParityAnalyzer:
    ...
    def _cross_dir_mappings(self):
        ...
        for py, c in {
            ...
            "hermes_cli/update_cmd.py":"src/cli/port_hermes_cli_update_cmd.c","hermes_cli/agent_import.py":"src/cli/port_hermes_cli_agent_import.c","hermes_cli/voice.py":"src/cli/voice.c","hermes_cli/web_server.py":"src/cli/web_server.c",
