"""AUTO-GENERATED integration oracle for port_slash_commands (gen_integration_oracle.py)."""
...
def _load(rel):
    ...
    for base in sys.path:
        ...
        try:
            ...
            continue
    return None
MODS['gateway.slash_commands'] = _load('gateway/slash_commands.py')

DISPATCH = {
    'slash_resume_row_visible': ('gateway.slash_commands', '_resume_row_visible'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_slash_commands.py <cases.json>\n"); return 2
