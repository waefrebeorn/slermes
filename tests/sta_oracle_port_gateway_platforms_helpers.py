"""AUTO-GENERATED integration oracle for port_gateway_platforms_helpers (gen_integration_oracle.py)."""
...
DISPATCH = {
    'gateway_platforms_helpers_is_table_row': ('gateway.platforms.helpers', 'is_table_row'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_gateway_platforms_helpers.py <cases.json>\n"); return 2
