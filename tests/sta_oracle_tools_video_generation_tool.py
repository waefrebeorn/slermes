"""AUTO-GENERATED oracle for tools_video_generation_tool (gen_oracle.py)."""
import sys, json, os
...
for line in sys.stdin:
    ...
    fn = rec['func']
    ARGS = {
        'cli_tools_video_generation_tool_check_video_generation_requirements': ('check_video_generation_requirements', []),
    }
    if fn not in ARGS:
        continue
    pyf, pargs = ARGS[fn]
