"""AUTO-GENERATED integration oracle for port_tools_fal_common (gen_integration_oracle.py)."""
...
def _load(rel):
    ...
    for base in sys.path:
        ...
        try:
            ...
            continue
    return None
MODS['tools.fal_common'] = _load('tools/fal_common.py')

DISPATCH = {
    'cli_tools_fal_common__extract_http_status': ('tools.fal_common', '_extract_http_status'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_tools_fal_common.py <cases.json>\n"); return 2
