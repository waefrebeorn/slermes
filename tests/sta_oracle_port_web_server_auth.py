"""AUTO-GENERATED integration oracle for port_web_server_auth (gen_integration_oracle.py)."""
...
DISPATCH = {
    'ws_has_valid_session_token': ('hermes_cli.web_server', '_has_valid_session_token'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_web_server_auth.py <cases.json>\n"); return 2
