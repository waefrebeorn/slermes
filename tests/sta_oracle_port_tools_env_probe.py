"""AUTO-GENERATED integration oracle for port_tools_env_probe (gen_integration_oracle.py)."""
...
DISPATCH = {
    'cli_tools_env_probe__has_pip_module': ('tools.env_probe', '_has_pip_module'),
    'cli_tools_env_probe__detect_pep668': ('tools.env_probe', '_detect_pep668'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_tools_env_probe.py <cases.json>\n"); return 2
