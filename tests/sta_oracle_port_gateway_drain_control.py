"""AUTO-GENERATED integration oracle for port_gateway_drain_control (gen_integration_oracle.py)."""
...
DISPATCH = {
    'gateway_drain_control_clear_drain_request': ('gateway.drain_control', 'clear_drain_request'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_gateway_drain_control.py <cases.json>\n"); return 2
