"""AUTO-GENERATED integration oracle for port_cron_jobs (gen_integration_oracle.py)."""
...
DISPATCH = {
    'cronjobs_parse_duration': ('cron.jobs', 'parse_duration'),
    'cronjobs_remove_job': ('cron.jobs', 'remove_job'),
    'cronjobs_claim_dispatch': ('cron.jobs', 'claim_dispatch'),
    'cronjobs_advance_next_run': ('cron.jobs', 'advance_next_run'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_cron_jobs.py <cases.json>\n"); return 2
