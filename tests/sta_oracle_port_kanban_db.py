"""AUTO-GENERATED integration oracle for port_kanban_db (gen_integration_oracle.py)."""
...
DISPATCH = {
    'profile_exists': ('hermes_cli.profiles', 'profile_exists'),
    'to_epoch': ('hermes_cli.kanban_db', '_to_epoch'),
    'looks_like_path': ('hermes_cli.kanban_db', '_looks_like_path'),
    'is_windows_batch_shim': ('hermes_cli.kanban_db', '_is_windows_batch_shim'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_kanban_db.py <cases.json>\n"); return 2
