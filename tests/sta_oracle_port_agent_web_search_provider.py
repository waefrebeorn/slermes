"""AUTO-GENERATED integration oracle for port_agent_web_search_provider (gen_integration_oracle.py)."""
...
DISPATCH = {
    'cli_agent_web_search_provider_supports_search': ('agent.web_search_provider', 'supports_search'),
    'cli_agent_web_search_provider_supports_extract': ('agent.web_search_provider', 'supports_extract'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_agent_web_search_provider.py <cases.json>\n"); return 2
