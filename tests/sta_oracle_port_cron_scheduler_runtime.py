"""AUTO-GENERATED integration oracle for port_cron_scheduler_runtime (gen_integration_oracle.py)."""
...
DISPATCH = {
    'scheduler_is_interrupted': ('cron.scheduler', '_is_interrupted'),
    'scheduler_consume_interrupted_flag': ('cron.scheduler', '_consume_interrupted_flag'),
    'scheduler_interpreter_shutting_down': ('cron.scheduler', '_interpreter_shutting_down'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_cron_scheduler_runtime.py <cases.json>\n"); return 2
