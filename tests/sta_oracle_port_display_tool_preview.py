"""AUTO-GENERATED integration oracle for port_display_tool_preview (gen_integration_oracle.py)."""
...
DISPATCH = {
    'cli_agent_display__verb_drops_preview': ('agent.display', 'verb_drops_preview'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_display_tool_preview.py <cases.json>\n"); return 2
