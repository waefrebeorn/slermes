"""AUTO-GENERATED integration oracle for port_hermes_cli_proxy_adapters_nous_portal (gen_integration_oracle.py)."""
...
def _load(rel):
    ...
    for base in sys.path:
        ...
        try:
            ...
            continue
    return None
MODS['hermes_cli.proxy.adapters.nous_portal'] = _load('hermes_cli/proxy/adapters/nous_portal.py')

DISPATCH = {
    'cli_hermes_cli_proxy_adapters_nous_portal_is_authenticated': ('hermes_cli.proxy.adapters.nous_portal', 'is_authenticated'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_hermes_cli_proxy_adapters_nous_portal.py <cases.json>\n"); return 2
