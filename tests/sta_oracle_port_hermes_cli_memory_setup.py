"""AUTO-GENERATED integration oracle for port_hermes_cli_memory_setup (gen_integration_oracle.py)."""
...
DISPATCH = {
    'cli_hermes_cli_memory_setup__install_dependencies': ('hermes_cli.memory_setup', '_install_dependencies'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_hermes_cli_memory_setup.py <cases.json>\n"); return 2
