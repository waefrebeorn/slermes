"""AUTO-GENERATED integration oracle for port_learning_graph_render (gen_integration_oracle.py)."""
...
def _load(rel):
    ...
    for base in sys.path:
        ...
        try:
            ...
            continue
    return None
MODS['agent.learning_graph_render'] = _load('agent/learning_graph_render.py')

DISPATCH = {
    'learning_graph_render_bucket_total': ('agent.learning_graph_render', 'total'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_learning_graph_render.py <cases.json>\n"); return 2
