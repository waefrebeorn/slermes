"""AUTO-GENERATED integration oracle for port_gateway_platform_registry (gen_integration_oracle.py)."""
...
DISPATCH = {
    'cli_gateway_platform_registry_unregister': ('gateway.platform_registry', 'unregister'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_gateway_platform_registry.py <cases.json>\n"); return 2
