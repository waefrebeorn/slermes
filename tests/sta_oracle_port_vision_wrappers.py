"""AUTO-GENERATED integration oracle for port_vision_wrappers (gen_integration_oracle.py)."""
...
DISPATCH = {
    'vi_validate_image_url_async': ('tools.vision_tools', '_validate_image_url_async'),
    'vi_should_use_native_vision_fast_path': ('tools.vision_tools', '_should_use_native_vision_fast_path'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_vision_wrappers.py <cases.json>\n"); return 2
