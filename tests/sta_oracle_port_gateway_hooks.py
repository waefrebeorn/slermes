"""AUTO-GENERATED integration oracle for port_gateway_hooks (gen_integration_oracle.py)."""
...
def _load(rel):
    ...
    for base in sys.path:
        ...
        try:
            ...
            continue
    return None
MODS['gateway.hooks'] = _load('gateway/hooks.py')

DISPATCH = {
    'cli_gateway_hooks_discover_and_load': ('gateway.hooks', 'discover_and_load'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_gateway_hooks.py <cases.json>\n"); return 2
