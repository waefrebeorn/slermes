"""AUTO-GENERATED integration oracle for port_cron_scheduler_helpers (gen_integration_oracle.py)."""
...
DISPATCH = {
    'scheduler_is_cron_silence_response': ('cron.scheduler', '_is_cron_silence_response'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_cron_scheduler_helpers.py <cases.json>\n"); return 2
