/* AUTO-GENERATED oracle harness for tools_image_generation_tool (gen_oracle.py). */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(void){
  ...
  printf("{\"func\":\"image_gen_load_fal_client\",\"ret\":0}\n", "image_gen_load_fal_client", image_gen_load_fal_client());
  return 0;
}
