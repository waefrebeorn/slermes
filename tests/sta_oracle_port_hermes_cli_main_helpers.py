"""AUTO-GENERATED integration oracle for port_hermes_cli_main_helpers (gen_integration_oracle.py)."""
...
DISPATCH = {
    'is_termux_env': ('hermes_cli.main', '_is_termux_env'),
}

def main():
    if len(sys.argv) < 2: sys.stderr.write("usage: sta_oracle_port_hermes_cli_main_helpers.py <cases.json>\n"); return 2
