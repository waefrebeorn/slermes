...
DISPATCH = {
    ...
    'cli_agent_bedrock_adapter_is_stale_connection_error': ('agent.bedrock_adapter', 'is_stale_connection_error'),
    'cli_agent_bedrock_adapter_is_streaming_access_denied_error': ('agent.bedrock_adapter', 'is_streaming_access_denied_error'),
}
