...
declare global {
  interface Window {
    hermesDesktop: {
      ...
      getProfileRoutes: (
        profiles: string[],
      ) => Promise<DesktopPluginProfileRoute[]>;
      ...
      petOverlay: {
        ...
        ) => Promise<{ ok: boolean; bounds?: PetOverlayBounds }>;
        ...
        onState: (
          callback: (payload: PetOverlayStatePayload) => void,
        ) => () => void;
        onControl: (
          callback: (payload: PetOverlayControl) => void,
        ) => () => void;
      };
      ...
      hud?: {
        ...
        onCursor: (
          callback: (point: { x: number; y: number } | null) => void,
        ) => () => void;
        onGameOverlay: (
          callback: (state: { active: boolean; app: string }) => void,
        ) => () => void;
      };
      ...
      quickEntry: {
        ...
        onState: (
          callback: (payload: QuickEntryStatePush) => void,
        ) => () => void;
        // Primary renderer subscribes to submits captured by the quick window.
        onSubmit: (
          callback: (payload: QuickEntrySubmitPayload | string) => void,
        ) => () => void;
      ...
      connections: {
        ...
        updateManaged?: (
          id: string,
        ) => Promise<DesktopManagedConnectionUpdateResult>;
        ...
        updateAll?: (options?: {
          ...
          ok: boolean;
          results: DesktopConnectionUpdateResult[];
        }>;
      ...
      cloud: {
        ...
        agentSignIn: (
          dashboardUrl: string,
        ) => Promise<DesktopCloudAgentSignInResult>;
      };
      profile: {
      ...
      dataUrlReadMax?: {
        ...
        set: (
          maxMb: number,
        ) => Promise<{ defaultMaxMb: number; maxBytes: number; maxMb: number }>;
      };
      ...
      settings: {
        ...
        pickDefaultProjectDir: () => Promise<{
          canceled: boolean;
          dir: null | string;
        }>;
        setDefaultProjectDir: (
          dir: null | string,
        ) => Promise<{ dir: null | string }>;
      };
      zoom?: {
        ...
        onChanged: (
          callback: (payload: { level: number; percent: number }) => void,
        ) => () => void;
      };
      ...
      terminal: {
        ...
        onExit: (
          id: string,
          callback: (payload: HermesTerminalExit) => void,
        ) => () => void;
        resize: (
          id: string,
      ...
      onPreviewNav?: (
        callback: (command: "back" | "forward" | "reload") => void,
      ) => () => void;
      ...
      onWindowStateChanged?: (
        callback: (payload: HermesWindowState) => void,
      ) => () => void;
      ...
      onPreviewFileChanged: (
        callback: (payload: HermesPreviewFileChanged) => void,
      ) => () => void;
      ...
      onBootProgress: (
        callback: (payload: DesktopBootProgress) => void,
      ) => () => void;
      ...
      onBootstrapEvent: (
        callback: (payload: DesktopBootstrapEvent) => void,
      ) => () => void;
