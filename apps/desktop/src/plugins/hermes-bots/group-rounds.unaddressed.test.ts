...
describe("unaddressedGroupMentions", () => {
  it("flags a cited member with no later post", () => {
    room([
      from("alpha", "zzzz-0002", "hello"),
      from("beta", "aaaa-0003", "ping @gamma — take this"),
    ]);
  ...
  it("re-flags a handoff cited again after the answer", () => {
    room([
      from("beta", "a", "ping @gamma"),
      from("gamma", "b", "on it"),
      from("beta", "c", "one more thing @gamma"),
    ]);
