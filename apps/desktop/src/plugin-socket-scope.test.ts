...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } =
  await import("@/hermes");
const { closeSecondaryGateways, configureGatewayRegistry, setPrimaryGateway } =
  ...
  Object.defineProperty(window, "hermesDesktop", {
    ...
    value: {
      ...
      getGatewayWsUrl: vi.fn(
        async () => "wss://pool.invalid/api/ws?ticket=fake",
      ),
      getGatewayWsUrlFor: vi.fn(
        async () => "wss://homelab.invalid/api/ws?ticket=fake",
      ),
