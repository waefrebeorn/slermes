...
export function ModelPickerOverlay({
  ...
  const focusedModel = useStoreSelector(
    $focusedSessionState,
    (state) => state?.model ?? null,
  );
  const focusedProvider = useStoreSelector(
    $focusedSessionState,
  ...
  const currentModel =
    focusedRuntimeId && focusedModel !== null ? focusedModel : primaryModel;
  const currentProvider =
    focusedRuntimeId && focusedProvider !== null
      ? focusedProvider
      : primaryProvider;
  ...
  return (
    <ModelPickerDialog
      ...
      onSelect={(selection) =>
        (pickerOwner.route ? selectFocusedModel : onSelect)({
          ...selection,
          sessionId,
        })
      }
