...
export const OVERLAY_TOP_CLEARANCE =
  "pt-[calc(var(--titlebar-height)/2-0.4375rem)]";
  ...
  useEffect(() => {
    ...
    const onKeyDown = (event: KeyboardEvent) => {
      if (
        ...
        !isTopEscapeLayer(ESCAPE_PRIORITY.overlay)
      ) {
        return;
      }
    ...
    >
      <div className="relative h-full min-h-0">
        ...
        >
          ...
          <div className={cn("min-h-0 flex flex-1 flex-col", contentClassName)}>
            {children}
          </div>
        </div>
