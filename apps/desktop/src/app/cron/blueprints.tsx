...
export function initialBlueprintValues(
  ...
  for (const field of blueprint.fields) {
    ...
    out[field.name] =
      isDeliverField(field) && (seeded === "" || seeded === "origin")
        ? DESKTOP_DELIVER_DEFAULT
        : seeded;
  }
...
export function blueprintSlotHelp(
  field: AutomationBlueprintField,
): string | undefined {
  return field.help && field.type !== "text" && !isDeliverField(field)
    ? field.help
    : undefined;
}
