...
const STEPS: readonly NoticeStep[] = [
  ...
  },
  {
    ...
    kind: "sticky",
    level: "warn",
    text: "⚠ You've used $165.00 of your $220.00 cap",
  },
  {
    key: "credits.usage",
    kind: "sticky",
    level: "warn",
    text: "⚠ You've used $198.00 of your $220.00 cap",
  },
  {
...
function isTriggerChord(e: KeyboardEvent): boolean {
  return (
    e.ctrlKey && e.shiftKey && !e.metaKey && !e.altKey && e.code === "KeyC"
  );
}
...
export function installCreditsNoticeDemo(): () => void {
  ...
  (window as unknown as { __creditsDemo?: () => void }).__creditsDemo =
    stepCreditsNoticeDemo;
  ...
  console.info(
    "[dev] credit-notice demo ready — press Ctrl+Shift+C, or run window.__creditsDemo()",
  );
