...
function AttachmentPill({
  ...
  const lightboxSrc =
    attachment.kind === "image" && !isUploading
      ? attachment.previewUrl || loadedImageSrc
      : undefined;
      ...
      <Tip label={attachment.path || attachment.detail || attachment.label}>
        <div className="group/attachment relative min-w-0 shrink-0">
          <button
            ...
            aria-label={
              canPreview ? c.previewLabel(attachment.label) : attachment.label
            }
            className={cn(
