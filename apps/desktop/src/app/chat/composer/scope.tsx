...
export const useComposerScope = (): ComposerScope =>
  useContext(ComposerScopeContext);
...
export const useComposerSurfaceId = (): string | null =>
  useContext(ComposerSurfaceContext);
