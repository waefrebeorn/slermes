...
describe("hudResizeBounds", () => {
  ...
  it("resizes from every CanvasTTY edge and corner while preserving the opposite edges", () => {
    expect(hudResizeBounds(origin, "n", 40, 30)).toEqual({
      x: 100,
      y: 230,
      width: 620,
      height: 290,
    });
    expect(hudResizeBounds(origin, "ne", 40, 30)).toEqual({
      x: 100,
      y: 230,
      width: 660,
      height: 290,
    });
    expect(hudResizeBounds(origin, "e", 40, 30)).toEqual({
      x: 100,
      y: 200,
      width: 660,
      height: 320,
    });
    expect(hudResizeBounds(origin, "se", 40, 30)).toEqual({
      x: 100,
      y: 200,
      width: 660,
      height: 350,
    });
    expect(hudResizeBounds(origin, "s", 40, 30)).toEqual({
      x: 100,
      y: 200,
      width: 620,
      height: 350,
    });
    expect(hudResizeBounds(origin, "sw", 40, 30)).toEqual({
      x: 140,
      y: 200,
      width: 580,
      height: 350,
    });
    expect(hudResizeBounds(origin, "w", 40, 30)).toEqual({
      x: 140,
      y: 200,
      width: 580,
      height: 320,
    });
    expect(hudResizeBounds(origin, "nw", 40, 30)).toEqual({
      x: 140,
      y: 230,
      width: 580,
      height: 290,
  ...
  it("clamps at the minimum without moving the opposite edge", () => {
    expect(hudResizeBounds(origin, "nw", 1000, 1000)).toEqual({
      x: 340,
      y: 360,
      width: 380,
      height: 160,
    });
    expect(hudResizeBounds(origin, "se", -1000, -1000)).toEqual({
      x: 100,
      y: 200,
      width: 380,
      height: 160,
