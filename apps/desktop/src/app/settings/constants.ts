...
export const PROVIDER_GROUPS: ProviderPrefix[] = [
  ...
  },
  {
    ...
    name: "Hugging Face",
    description:
      "Inference Providers — 20+ open models via router.huggingface.co",
  ...
  },
  {
    ...
    name: "Azure Foundry",
    description:
      "Azure AI Foundry custom endpoints (OpenAI / Anthropic-compatible)",
...
export const FIELD_DESCRIPTIONS: Record<string, string> = defineFieldCopy({
  model:
    "Used for new chats unless you pick a different model in the composer.",
  modelContextLength:
    "Leave at 0 to use the selected model's detected context window.",
  fallbackProviders:
  ...
  tts: {
    xai: {
      ...
      language:
        'Spoken language code (e.g. en, pt-BR) or "auto" for auto-detection.',
      ...
      optimizeStreamingLatency:
        "Latency vs. quality trade-off. 0 = best quality, 2 = lowest latency.",
      sampleRate:
        "Audio sample rate in Hz. Higher = better quality, larger files.",
  ...
  stt: {
    ...
    echoTranscripts:
      "Post the raw 🎙️ transcript of voice messages back to the chat.",
    elevenlabs: {
      languageCode:
