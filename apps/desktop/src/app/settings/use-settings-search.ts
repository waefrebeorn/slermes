  ...
  const appearanceEntries: SettingsSearchEntry[] = [
    {
      ...
      target: {
        setting: APPEARANCE_SETTING_IDS.language,
        view: "config:appearance",
      },
    },
    {
      context: appearanceContext,
      ...
      target: {
        setting: APPEARANCE_SETTING_IDS.theme,
        view: "config:appearance",
      },
    },
    {
      ...
      target: {
        setting: APPEARANCE_SETTING_IDS.uiScale,
        view: "config:appearance",
      },
    },
      ...
      ? [
          {
            ...
            target: {
              setting: APPEARANCE_SETTING_IDS.translucency,
      ...
      : []),
    {
      ...
      target: {
        setting: APPEARANCE_SETTING_IDS.backdrop,
        view: "config:appearance",
      },
    },
    {
      ...
      target: {
        setting: APPEARANCE_SETTING_IDS.introSplash,
        view: "config:appearance",
      },
    },
    {
      ...
      target: {
        setting: APPEARANCE_SETTING_IDS.toolView,
        view: "config:appearance",
      },
    },
    {
      ...
      target: {
        setting: APPEARANCE_SETTING_IDS.embeds,
        view: "config:appearance",
      },
    },
  ];
