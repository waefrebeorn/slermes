...
export function SessionsSettings() {
  ...
  if (loading) {
    return (
      <SettingsSkeleton sections={[{ rows: 1 }, { heading: true, rows: 4 }]} />
    );
  }
  ...
  return (
    <SettingsContent>
      ...
      {sessions.length === 0 ? (
        <EmptyState
          description={s.emptyArchivedDesc}
          title={s.emptyArchivedTitle}
        />
      ) : (
            ...
            return (
              ...
              >
                <ListRow
                  ...
                  hint={
                    label
                      ? `${label} · ${s.messages(session.message_count)}`
                      : s.messages(session.message_count)
                  }
