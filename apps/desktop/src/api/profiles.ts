...
function profileOwnerScoped(scope?: ProfileScope): {
  connectionId?: string;
  profile?: string;
} {
...
export function deleteProfile(
  ...
  const scopedProfile =
    scope && typeof scope === "object" ? scope.profile?.trim() : undefined;
  ...
  if (
    ...
    scopedProfile?.toLowerCase() === "default"
  ) {
...
export function getProfileSetupCommand(
  name: string,
): Promise<ProfileSetupCommand> {
