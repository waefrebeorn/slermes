...
const SYSTEM_MONO =
  'Menlo, Monaco, "SF Mono", "Courier Prime", monospace, ' + EMOJI_FALLBACK;
...
const nousAltTint = (pct: number) =>
  `color-mix(in srgb, ${NOUS_ALT_BLUE} ${pct}%, #FFFFFF)`;
const nousAltTintTransparent = (pct: number) =>
  `color-mix(in srgb, ${NOUS_ALT_BLUE} ${pct}%, transparent)`;
