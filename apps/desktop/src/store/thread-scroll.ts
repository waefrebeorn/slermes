...
export const onScrollToBottomRequest = (
  handler: () => void,
...
export const notifyThreadEditOpen = () =>
  editOpenHandlers.forEach((handler) => handler());
...
export const notifyThreadEditClose = () =>
  editCloseHandlers.forEach((handler) => handler());
