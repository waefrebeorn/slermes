...
describe("openSessionInNewWindow", () => {
  ...
  it("notifies on an ok:false result", async () => {
    installBridge(
      vi.fn().mockResolvedValue({ ok: false, error: "invalid-session-id" }),
    );
...
describe("openNewWindow", () => {
  ...
  it("notifies on an ok:false result", async () => {
    installBridge(
      undefined,
      vi.fn().mockResolvedValue({ ok: false, error: "nope" }),
    );
...
describe("openBrowserInNewWindow", () => {
  ...
  it("returns false and notifies on an ok:false result", async () => {
    installBridge(
      undefined,
      undefined,
      vi.fn().mockResolvedValue({ ok: false, error: "invalid-tab-id" }),
    );
