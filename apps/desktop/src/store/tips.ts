...
export const $retiredTips = persistentAtom<string[]>(
  "hermes.desktop.tips.retired.v1",
  [],
  Codecs.stringArray,
);
export const $lastTipId = persistentAtom<null | string>(
  "hermes.desktop.tips.last.v1",
  null,
  Codecs.nullableText,
);
