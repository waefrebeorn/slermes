...
const REASONING_COLLAPSED_BY_DEFAULT_STORAGE_KEY =
  "hermes.desktop.reasoning.collapsedByDefault";
...
$reasoningCollapsedByDefault.subscribe((value) =>
  persistBoolean(REASONING_COLLAPSED_BY_DEFAULT_STORAGE_KEY, value),
);
