...
export function isLiveTailReplyId(id: string): boolean {
  return (
    id.startsWith("assistant-stream-") || id.startsWith("inflight-assistant-")
  );
}
...
export function assistantReplyOrdinal(
...
function lastVisibleAssistant(
  messages: readonly SpokenReplyMessage[],
): SpokenReplyMessage | undefined {
