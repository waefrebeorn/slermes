...
export type AnnotatePinDraft = Omit<AnnotatePin, "id" | "number"> & {
  id?: string;
};
...
export function addAnnotatePin(
  stack: AnnotateStack,
  draft: AnnotatePinDraft,
): AnnotateStack {
...
export function updateAnnotatePinNote(
  stack: AnnotateStack,
  id: string,
  note: string,
): AnnotateStack {
...
export function removeAnnotatePin(
  stack: AnnotateStack,
  id: string,
): AnnotateStack {
  return {
