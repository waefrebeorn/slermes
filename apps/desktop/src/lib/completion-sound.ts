...
import {
  ...
  resolveCompletionSoundVariantId,
...
export function previewCompletionSound(variantId?: number) {
  playVariant(
    resolveCompletionSoundVariantId(
      variantId ?? $completionSoundVariantId.get(),
    ),
  );
}
