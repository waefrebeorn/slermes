...
describe("displayPath", () => {
  it("collapses a macOS home prefix to ~", () => {
    expect(displayPath("/Users/brooklyn/www/hermes-agent")).toBe(
      "~/www/hermes-agent",
    );
  ...
  it("honours an explicit home override", () => {
    ...
    expect(displayPath("/elsewhere/repo", { home: "/opt/work" })).toBe(
      "/elsewhere/repo",
    );
  });
  ...
  it("normalizes separators and trailing slashes", () => {
    expect(normalizeDisplayPath("C:\\Users\\me\\src\\")).toBe(
      "C:/Users/me/src",
    );
