...
export const dropdownMenuSectionLabel =
  "px-2.5 pt-1 pb-0.5 text-[0.625rem] font-medium uppercase tracking-wide";
...
const DROPDOWN_NAV_KEYS = new Set([
  "ArrowDown",
  "ArrowUp",
  "Enter",
  "Escape",
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      className={cn(
        "px-2 py-1 text-xs font-medium text-(--ui-text-tertiary) data-[inset]:pl-7",
        className,
      )}
      data-inset={inset}
