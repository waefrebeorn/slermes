...
export const ar = defineLocale({
  sendDiagnostics: {
    ...
    copyLink: "نسخ الرابط",
    uploadIdFallback: (id) =>
      `لم يتم إرجاع رابط عرض — اذكر معرّف الرفع ${id} للدعم`,
    doneTitle: "تم إرسال التشخيصات",
    doneDescription:
      "تم رفع الحزمة بشكل خاص. شارك الرابط أدناه في محادثة الدعم لكي يتمكن الفريق من رؤية سجلاتك.",
  ...
  boot: {
    ...
    errors: {
      ...
      backgroundExitedDuringStartup:
        "خرجت عملية Hermes الخلفية أثناء بدء التشغيل.",
    ...
    failure: {
      ...
      description:
        "لم تعمل البوابة الخلفية. جرب إحدى خطوات الاسترداد أدناه. لن يحذف ذلك محادثاتك أو إعداداتك.",
      remoteTitle: "تسجيل الدخول للبوابة البعيدة مطلوب",
      remoteDescription:
        "انتهت جلسة البوابة البعيدة. سجل الدخول مرة أخرى لإعادة الاتصال.",
      retry: "إعادة المحاولة",
      ...
      cloudDownHint:
        "تفتح الأزرار أدناه بوابة Nous (حالة المثيل وعناصر التحكم) أو Discord للحصول على الدعم.",
      cloudDownCheckPortal: "التحقق من حالة البوابة",
      cloudDownDiscord: "الحصول على مساعدة عبر Discord",
      openLogs: "فتح السجلات",
      repairHint:
        "يعيد الإصلاح تشغيل المثبت وقد يستغرق بضع دقائق على جهاز جديد.",
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      "خلفية Hermes أقدم من إصدار سطح المكتب الحالي وقد لا تعمل كما يجب. حدثهما ليتوافقا.",
    ...
    errors: {
      ...
      methodNotAllowed:
        "رفضت خلفية سطح المكتب هذا الطلب (405 Method Not Allowed). جرب إعادة تشغيل Hermes Desktop.",
      microphonePermission: "تم رفض إذن الميكروفون.",
      openaiRejectedApiKey: "رفض OpenAI مفتاح API.",
      openaiRejectedApiKeyWithStatus: (status) =>
        `رفض OpenAI مفتاح API (${status} invalid_api_key).`,
      openaiTtsNeedsKey:
        "يتطلب OpenAI TTS المفتاح VOICE_TOOLS_OPENAI_KEY أو OPENAI_API_KEY.",
      codeSkewRestartRequired:
        "بعد التحديث ما زال هذا الخلفية يشغّل كودا قديما. أعد تشغيله لتحميل الكود الجديد.",
    },
    voice: {
      ...
      microphoneConstraintsUnsupported:
        "قيود الميكروفون غير مدعومة على هذا الجهاز.",
  ...
  remoteDisplayBanner: {
    message: (reason) =>
      `العرض البرمجي نشط — تم اكتشاف شاشة بعيدة (${reason}). تم تعطيل تسريع GPU لمنع الوميض.`,
  },
  titlebar: {
    ...
    unreadSessions: (count) =>
      count === 1 ? "جلسة واحدة غير مقروءة" : `${count} جلسات غير مقروءة`,
    ...
    layoutEditorTitle: (modifier) =>
      `محرر التخطيط — انقر مع ${modifier} لإعادة ضبط التخطيط`,
  },
  keybinds: {
    title: "اختصارات لوحة المفاتيح",
    subtitle: (open) =>
      `انقر على اختصار لإعادة تعيينه · ${open} يعيد فتح هذه اللوحة.`,
  ...
  settings: {
    ...
    notifications: {
      ...
      testSent:
        "تم إرسال التجربة. إذا لم يظهر شيء، تحقق من أذونات الإشعارات في نظام التشغيل ووضع التركيز/عدم الإزعاج.",
      testUnsupported: "هذا النظام لا يدعم الإشعارات الأصلية.",
      completionSoundTitle: "صوت الاكتمال",
      completionSoundDesc:
        "يُشغّل عند انتهاء دور الوكيل. اختر إعدادا مسبقا وعاينه هنا.",
    ...
    appearance: {
      ...
      translucencyGlassDesc:
        "زجاج غير لامع: يظهر سطح المكتب كضبابية ناعمة بينما يبقى النص واضحًا.",
      ...
      reactionsDesc:
        "تفاعلات إيموجي بأسلوب iMessage — تفاعل مع الرسائل، ويمكن لـ Hermes التفاعل مع رسائلك.",
      ...
      composerPopoutDesc:
        "السماح بسحب محرر الرسائل خارج موضعه. عطّل هذا الخيار لإبقائه مثبتًا في الأسفل.",
      vibeHeartsTitle: "قلوب المزاج",
      vibeHeartsDesc:
        "قلوب عائمة عند قول شكراً أو أحبك أو good bot أو إرسال قلب. منفصلة عن تفاعلات الرسائل أعلاه.",
      ...
      embedsOff: "إيقاف",
      embedsReset: (count) =>
        `إعادة تعيين ${count} ${count === 1 ? "خدمة مسموح بها" : "خدمة مسموح بها"}`,
      resumeLastSessionTitle: "إعادة فتح آخر محادثة عند التشغيل",
      resumeLastSessionDesc:
        "متابعة من حيث توقفت عند بدء التطبيق. أوقفه للبدء دائمًا بمحادثة جديدة.",
      product: "مبسط",
      ...
      themeProfileNote: (profile) =>
        `سيطبق هذا الثيم على الملف الشخصي ${profile}.`,
      ...
      pet: {
        ...
        unreachable:
          "تعذّر الوصول إلى معرض petdex. تحقق من اتصالك وأعد فتح هذه الصفحة.",
        noMatch: (query) => `لا توجد حيوانات أليفة تطابق "${query}".`,
        installedTag: "مثبّت",
        generatedTag: "مُولّد",
        countCapped: (cap, total) =>
          `عرض ${cap} من ${total} — اكتب لتضييق النتائج.`,
    ...
    fieldDescriptions: {
      model:
        "يستخدم في المحادثات الجديدة ما لم تختر نموذجاً مختلفاً من محرر الرسائل.",
      modelContextLength:
        "اتركه 0 لاستخدام نافذة السياق المكتشفة للنموذج المحدد.",
      fallbackProviders:
        "إدخالات احتياطية بصيغة provider:model لتجربتها إذا فشل النموذج الافتراضي.",
      "display.personality": "أسلوب المساعد الافتراضي للجلسات الجديدة.",
      "display.showReasoning": "يعرض أقسام التفكير عندما توفرها الخلفية.",
      timezone:
        "تستخدم عندما يحتاج Hermes إلى سياق الوقت المحلي. اتركها فارغة لاستخدام منطقة النظام.",
      "agent.imageInputMode": "يتحكم في طريقة إرسال مرفقات الصور إلى النموذج.",
      "agent.maxTurns":
        "الحد الأعلى لدورات استدعاء الأدوات قبل أن يوقف Hermes التشغيل.",
      "terminal.cwd": "مجلد المشروع الافتراضي لعمل الأدوات والطرفية.",
      "terminal.persistentShell":
        "يحافظ على حالة الصدفة بين الأوامر عندما تدعمها الخلفية.",
      "terminal.envPassthrough": "متغيرات البيئة التي تمرر إلى تنفيذ الأدوات.",
      "terminal.dockerImage":
        "صورة الحاوية المستخدمة عند اختيار Docker كخلفية تنفيذ.",
      ...
      fileReadMaxChars:
        "أقصى عدد أحرف يستطيع Hermes قراءته من ملف واحد في الطلب.",
      ...
      "security.redactSecrets":
        "يخفي الأسرار المكتشفة من المحتوى المرئي للنموذج قدر الإمكان.",
      "checkpoints.enabled": "ينشئ لقطات رجوع قبل تعديلات الملفات.",
      "memory.memoryEnabled":
        "يحفظ ذكريات دائمة يمكن أن تساعد الجلسات القادمة.",
      ...
      "stt.elevenlabs.languageCode":
        "رمز لغة ISO-639-3 اختياري. اتركه فارغاً للاكتشاف التلقائي.",
    ...
    quickEntry: {
      ...
      enabledDesc:
        "استدعِ محرّرا صغيرا من أي مكان باختصار عام وأرسل طلبا دون فتح Hermes.",
      shortcutTitle: "اختصار الإدخال السريع",
      shortcutDesc:
        "يحتاج إلى مفتاح تعديل واحد على الأقل، مثل CommandOrControl+Shift+Space.",
    ...
    gateway: {
      ...
      envOverrideDesc:
        "أزل HERMES_DESKTOP_REMOTE_URL و HERMES_DESKTOP_REMOTE_TOKEN لاستخدام الإعداد المحفوظ أدناه.",
      localTitle: "بوابة محلية",
      localDesc:
        "تشغيل خلفية Hermes خاصة على localhost. هذا هو الافتراضي ويعمل دون اتصال.",
      ...
      remoteUrlDesc:
        "الرابط الأساسي لخلفية لوحة التحكم البعيدة. يمكن استخدام بادئات مسار مثل /hermes.",
      probing: "جار فحص طريقة مصادقة هذه البوابة...",
      probeError:
        "تعذر الوصول إلى هذه البوابة الآن. تحقق من الرابط وستظهر طريقة المصادقة عند الاستجابة.",
      ...
      authSignedInPassword:
        "هذه البوابة تستخدم اسم مستخدم وكلمة مرور. أنت مسجل الدخول والجلسة تتجدد تلقائياً.",
      authSignedInOauth:
        "هذه البوابة تستخدم OAuth. أنت مسجل الدخول والجلسة تتجدد تلقائياً.",
      authNeedsPassword:
        "هذه البوابة تستخدم اسم مستخدم وكلمة مرور. سجل الدخول لتفويض تطبيق سطح المكتب.",
      authNeedsOauth: (provider) =>
        `هذه البوابة تستخدم OAuth. سجل الدخول عبر ${provider} لتفويض تطبيق سطح المكتب.`,
      tokenTitle: "رمز الجلسة",
      tokenDesc:
        "رمز جلسة لوحة التحكم المستخدم لطلبات REST و WebSocket. اتركه فارغاً للإبقاء على الرمز المحفوظ.",
      existingToken: (value) => `رمز موجود ${value}`,
      savedToken: "محفوظ",
      pasteSessionToken: "ألصق رمز الجلسة",
      keychainEncryptionTitle:
        "تشفير الأسرار المحفوظة باستخدام سلسلة مفاتيح النظام",
      ...
      diagnosticsDesc:
        "اعرض desktop.log في مدير الملفات، وهذا مفيد عند فشل تشغيل البوابة.",
      openLogs: "فتح السجلات",
      incompleteTitle: "إعداد البوابة البعيدة غير مكتمل",
      incompleteSignIn:
        "أدخل رابط البوابة البعيدة وسجل الدخول قبل التبديل إلى البعيد.",
      incompleteToken:
        "أدخل رابط البوابة البعيدة ورمز الجلسة قبل التبديل إلى البعيد.",
      incompleteSignInTest:
        "أدخل رابط البوابة البعيدة وسجل الدخول قبل الاختبار.",
      incompleteTokenTest:
        "أدخل رابط البوابة البعيدة ورمز الجلسة قبل الاختبار.",
      ...
      restartingMessage:
        "سيعيد Hermes Desktop الاتصال باستخدام الإعدادات المحفوظة.",
      savedMessage: "تم الحفظ للتشغيل القادم.",
      connectedTo: (baseUrl, version) =>
        `متصل بـ ${baseUrl}${version ? ` · Hermes ${version}` : ""}`,
    ...
    profileScope: {
      ...
      editsProfile: (profile) =>
        `تنطبق التغييرات في هذه الصفحة على الملف الشخصي «${profile}».`,
    },
    mcp: {
      ...
      deepLinkNameInvalid:
        "الأسماء من 1-64 حرفا أو رقما أو نقطة أو شرطة أو شرطة سفلية.",
      deepLinkNameConflict: (name) =>
        `يوجد خادم باسم ${name} بالفعل — اختر اسما مختلفا أو ألغِ العملية.`,
      ...
      deepLinkErrorShape:
        "يجب أن تكون الإعدادات كائن JSON يحتوي على حقل `url` أو `command` نصي.",
    ...
    model: {
      ...
      appliesDesc:
        "ينطبق على الجلسات الجديدة. استخدم منتقي النموذج في صندوق الإنشاء لتبديل المحادثة النشطة فورا.",
      provider: "المزوّد",
      model: "النموذج",
      ...
      auxiliaryDesc:
        "تعمل المهام المساعدة على النموذج الرئيسي افتراضيا. عيّن نموذجا مخصصا لأي مهمة لتجاوز ذلك.",
    ...
    providers: {
      ...
      intro:
        "سجل الدخول باشتراكك دون نسخ مفتاح API. يشغّل Hermes تسجيل الدخول من المتصفح لك داخل التطبيق.",
      connected: "متصل",
      collapse: "طي",
      ...
      removeExternalGeneric: (provider) =>
        `${provider} يُدار عبر CLI خاص به — أزله من هناك.`,
      removeKeyManaged: (provider) =>
        `${provider} مُعدّ من مفتاح API. أزله من مفاتيح API.`,
      ...
      removeTerminalRunning: (provider) =>
        `جار تشغيل قطع اتصال ${provider} في الطرفية…`,
      ...
      localEndpoint: {
        ...
        description:
          "استخدم خادما محليا أو نقطة نهاية متوافقة مع OpenAI لهذا المزود.",
      },
    ...
    sessions: {
      ...
      deleteConfirm: (title) =>
        `حذف "${title}" نهائياً؟ لا يمكن التراجع عن هذا.`,
      defaultDirTitle: "مجلد المشروع الافتراضي",
      defaultDirDesc:
        "تبدأ الجلسات الجديدة في هذا المجلد ما لم تختر غيره. اتركه غير مضبوط لاستخدام مجلدك الرئيسي.",
      defaultDirUpdated:
        "تم تحديث مجلد المشروع الافتراضي، ابدأ محادثة جديدة (Ctrl/⌘+N) ليطبق التغيير",
    ...
    toolsets: {
      ...
      noProviderOptions:
        "لا تحتوي مجموعة الأدوات هذه على خيارات مزوّد — فعّلها لتعمل مع إعدادك الحالي.",
      noProviders: "لا يوجد مزوّدون متاحون لمجموعة الأدوات هذه الآن.",
      ready: "جاهز",
      nousIncluded:
        "مُضمّن مع اشتراك Nous — سجّل الدخول إلى Nous Portal للتفعيل.",
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend:
        "أعد تشغيل Hermes لاستخدام الحيوانات الأليفة — الخادم الخلفي أقدم من هذه الميزة.",
      ...
      toggleFailed: (enabled) =>
        `تعذّر ${enabled ? "تشغيل" : "إيقاف"} الحيوان الأليف.`,
    ...
    generatePet: {
      ...
      remixConfirmBody:
        "يولّد هذا مجموعة جديدة من المسوّدات باستخدام هذا كنقطة بداية. قد يستغرق عدة دقائق.",
      genericError: "فشل التوليد — حاول مجددا أو اختر اقتراحا.",
      referenceImageTooLarge:
        "صورة المرجع كبيرة جدا. استخدم واحدة أقل من 16 MB.",
      referenceImageInvalid:
        "تعذّرت قراءة صورة المرجع تلك. جرّب PNG أو JPG أو WebP أو GIF.",
      adopt: "تبنّي",
    ...
    hermesActiveSessions: (version, count) =>
      `Hermes ${version} لديه ${count} جلسة نشطة`,
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description:
        "ستعمل جلسات هذا الملف الشخصي على خادم Hermes البعيد الذي تحدده، بدلاً من هذا الجهاز.",
    ...
    notSet: "غير مضبوط",
    soulDesc:
      "الموجّه (prompt) النظامي وتعليمات الشخصية المضمّنة في هذا الملف الشخصي.",
    ...
    cloneFromDesc:
      "ينسخ الإعدادات والمهارات وSOUL.md من الملف الشخصي المصدر المحدد.",
    ...
    renameDescPrefix:
      "تؤدي إعادة التسمية إلى تحديث دليل الملف الشخصي وأي سكربتات تغليف في ",
    renameDescSuffix: ".",
  ...
  cron: {
    ...
    modelImpact: {
      ...
      message: (count) =>
        `سيتم تخطي ${count} من المهام المجدولة حتى تراجع إعدادات النموذج الخاصة بها.`,
    ...
    monthlyOnDayAt: (dayOfMonth, time) =>
      `شهريا في اليوم ${dayOfMonth} في ${time}`,
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm:
        "هذا يزيل المشروع المحفوظ من Hermes. تبقى الملفات ومستودعات git وأشجار العمل دون تغيير.",
    ...
    row: {
      ...
      deleteDesc: (title) =>
        `سيتم حذف «${title}» نهائيًا. لا يمكن التراجع عن هذا الإجراء.`,
      deleting: "جارٍ الحذف…",
  ...
  composer: {
    ...
    queueStuckBody:
      "ظل دور في قائمة الانتظار يفشل في الإرسال. ما زال في قائمة الانتظار — حاول إرساله مرة أخرى.",
    ...
    snippets: {
      codeReview: {
        label: "مراجعة الكود",
        description:
          "دقّق التغيير الحالي بحثًا عن الانحدارات والحالات الطرفية المُسقطة والاختبارات المفقودة.",
  ...
  statusStack: {
    ...
    coding: {
      ...
      revertConfirm:
        "هل تريد تجاهل التغييرات على هذا الملف واستعادته إلى الحالة المُودعة؟ لا يمكن التراجع عن هذا.",
      revertAllConfirm:
        "هل تريد تجاهل كل التغييرات واستعادة الملفات إلى الحالة المُودعة؟ لا يمكن التراجع عن هذا.",
      staged: "مُدرَج",
      ...
      agentShipPrompt:
        "راجع التغييرات الحالية، وأودعها برسالة إيداع تقليدية واضحة، وادفع الفرع، وافتح طلب سحب.",
      newBranch: "فرع جديد",
  ...
  updates: {
    ...
    unsupportedMessage:
      "لا يمكن لهذا الإصدار من Hermes تحديث نفسه من داخل التطبيق.",
    ...
    availableBodyBackend:
      "إصدار أحدث من واجهة Hermes الخلفية المتصلة جاهز للتثبيت.",
    availableBodyNoChangelog:
      "إصدار أحدث جاهز. ملاحظات الإصدار غير متاحة لنوع التثبيت هذا.",
    updateNow: "التحديث الآن",
    maybeLater: "ربما لاحقا",
    moreChanges: (count) =>
      `+ ${count} تغيير${count === 1 ? "" : "ات"} إضافي مُضمَّن.`,
    manualTitle: "التحديث من الطرفية",
    manualBody:
      "لقد ثبّتت Hermes من سطر الأوامر، لذا تُجرى التحديثات من هناك أيضا. الصق هذا في طرفيتك:",
    manualPickedUp:
      "سيلتقط Hermes الإصدار الجديد في المرة التالية التي تشغّله فيها.",
    ...
    applyingClose:
      "ستُغلق هذه النافذة أثناء تشغيل التحديث، ثم يعيد Hermes فتح نفسه تلقائيا.",
    ...
    blockerBody:
      "يحتاج Hermes إلى إيقاف هذه المعاينات المحلية قبل التحديث. لن يؤدي ذلك إلى تعديل ملفاتك أو حذفها.",
    ...
    applyStatus: {
      ...
      noReturn:
        "لم تعد الواجهة الخلفية إلى الاتصال. قد لا يكون التحديث قد اكتمل — تحقق من مضيف الواجهة الخلفية.",
    },
  },
  install: {
    stageStates: {
  ...
  onboarding: {
    ...
    headerDesc:
      "اربط مزوّد نماذج لبدء المحادثة. معظم الخيارات تتطلب نقرة واحدة.",
    preparingInstall:
      "يُكمل Hermes التثبيت. عادة ما يستغرق ذلك أقل من دقيقة في أول تشغيل.",
    ...
    connected: "متصل",
    featuredPitch:
      "اشتراك واحد، أكثر من 300 نموذج متقدم — الطريقة الموصى بها لتشغيل Hermes",
    ...
    apiKeyOptions: {
      openrouter: {
        ...
        description:
          "يستضيف مئات النماذج خلف مفتاح واحد. خيار افتراضي جيد للتثبيتات الجديدة.",
      },
      openai: {
    ...
    localApiKeyPlaceholder:
      "مفتاح API (اختياري — فقط إذا كانت نقطة النهاية تتطلبه)",
    ...
    connectedPicking: (provider) =>
      `تم ربط ${provider}. جار اختيار نموذج افتراضي...`,
    ...
    autoBrowser: (provider) =>
      `فتحنا ${provider} في المتصفح. صرّح لـ Hermes هناك وسيتم الاتصال تلقائياً دون نسخ أو لصق.`,
    ...
    deviceCodeOpened: (provider) =>
      `فتحنا ${provider} في المتصفح. أدخل هذا الرمز هناك:`,
  ...
  preview: {
    ...
    diskChangedBody:
      "تغيّر هذا الملف منذ أن فتحته. هل تريد الكتابة فوقه بنسختك، أم تجاهل تعديلاتك وإعادة التحميل؟",
    ...
    console: {
      ...
      sentMessage: (count) =>
        `أُضيف ${count} ${count === 1 ? "إدخال سجل" : "إدخالات سجل"} إلى المُنشئ`,
    },
    web: {
      ...
      lookingRestart: (taskId) =>
        `يبحث Hermes عن خادم معاينة لإعادة تشغيله (${taskId})`,
      restartingTitle: "جار إعادة تشغيل خادم المعاينة",
      restartingMessage:
        "يعمل Hermes في الخلفية. راقب كونسول المعاينة لمتابعة التقدم.",
      startRestartFailed: (message) =>
        `تعذّر بدء إعادة تشغيل الخادم: ${message}`,
      ...
      blankPageBody:
        "اكتب عنوانًا في الأعلى للتصفح، أو اطلب من Hermes فتح صفحة.",
      finishedRestarting: (message) =>
        `أنهى Hermes إعادة تشغيل خادم المعاينة${message ? `: ${message}` : ""}`,
      ...
      filesChanged: (count, url) =>
        `${count} تغييرات ملفات، جار إعادة تحميل المعاينة: ${url}`,
  ...
  zones: {
    ...
    editorHintPost:
      " يعكس الخط · اسحب عبر المناطق للدمج · اسحب الحواف المشتركة لتغيير الحجم",
  ...
  assistant: {
    thread: {
      ...
      resumeWhenBackgroundDone: (count) =>
        count === 1
          ? "سيُستأنف عند انتهاء المهمة الخلفية"
          : `سيُستأنف عند انتهاء ${count} مهام خلفية`,
      thinking: "يفكر...",
      thought: "فكّر",
      ...
      restoreBody:
        "يُزال كل ما يلي هذا الموجّه من المحادثة، ويُعاد تشغيل الموجّه من هنا.",
    ...
    approval: {
      ...
      alwaysDescription: (pattern) =>
        `السماح دائما بالأوامر المطابقة لـ ${pattern}`,
    ...
    clarify: {
      ...
      questionProgress: (answered, total) =>
        `تمت الإجابة على ${answered} من ${total}`,
    },
    tool: {
      copyCode: "نسخ الكود",
      ...
      titleTemplates: {
        ...
        runningPrefixedTool: (prefix, action) =>
          `جار تشغيل ${prefix.toLowerCase()} ${action.toLowerCase()}`,
  ...
  desktop: {
    ...
    noProfileNamed: (target, available) =>
      `لا يوجد ملف باسم ${target}. المتاح: ${available}`,
    ...
    readOnlyTranscriptSendBlocked:
      "هذه المحادثة مفتوحة كنصّ محفوظ للقراءة فقط — الإرسال معطّل.",
    ...
    handoff: {
      ...
      success: (platform) =>
        `تم التسليم إلى ${platform}. استأنف هنا في أي وقت.`,
      systemNote: (platform) =>
        `↻ تم التسليم إلى ${platform} — استأنف هنا في أي وقت.`,
      failed: (error) => `فشل التسليم: ${error}`,
      timedOut:
        "انتهت المهلة في انتظار البوابة. هل `hermes gateway` قيد التشغيل؟",
    },
  },
  errors: {
