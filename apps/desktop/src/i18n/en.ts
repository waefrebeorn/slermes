...
export const en: Translations = {
  ...
  notifications: {
    ...
    updateReadyMessage: (count) =>
      `${count} new change${count === 1 ? "" : "s"} available.`,
    ...
    errors: {
      ...
      gatewayAuthFailed:
        "Gateway authentication failed — check your API_SERVER_KEY.",
      methodNotAllowed:
      ...
      openaiTtsNeedsKey:
        "OpenAI TTS needs VOICE_TOOLS_OPENAI_KEY or OPENAI_API_KEY.",
      codeSkewRestartRequired:
        "This backend is running old code after an update. Restart it to load the new code.",
    },
    voice: {
  ...
  billingBlock: {
    ...
    fallbackMessage:
      "Your account is out of credits. Add credits to keep going.",
  ...
  sendDiagnostics: {
    ...
    copyLink: "Copy link",
    uploadIdFallback: (id) =>
      `No view link returned — quote upload ID ${id} to support`,
  ...
  titlebar: {
    ...
    unreadSessions: (count) =>
      count === 1 ? "1 unread session" : `${count} unread sessions`,
    ...
    layoutEditorTitle: (mod) =>
      `Layout editor — ${mod}-click resets the layout`,
  },

  keybinds: {
    title: "Keyboard shortcuts",
    subtitle: (open) =>
      `Click a shortcut to rebind it · ${open} reopens this panel.`,
  ...
  settings: {
    ...
    plugins: {
      ...
      agent: {
        ...
        updateBackendToManage:
          "Update the Hermes backend to manage this plugin from Desktop.",
        sources: {
          bundled: "bundled",
          user: "user",
          git: "git",
      ...
      installModal: {
        ...
        agentTargetLocal: (profile) =>
          `Installs into the ${profile} backend (~/.hermes/plugins/)`,
        agentTargetRemote: (profile) =>
          `Installs into the connected ${profile} backend`,
        desktopTarget: "Installs into this app's local desktop-plugins folder",
        desktopOnlyNote:
          "Desktop-only packages do not install a backend agent plugin.",
        insecureWarning:
        ...
        probeUnavailable:
          "Plugin inspection is unavailable in this environment.",
        desktopUnavailable:
          "Desktop plugin install is unavailable in this environment.",
        ...
        missingEnv: (vars) =>
          `Missing env vars: ${vars}. Add them in Settings → Keys.`,
      },
    },
    notifications: {
      title: "Notifications",
      ...
      focusedHint:
        "Completion alerts only fire while Hermes is in the background.",
      kinds: {
        approval: {
        ...
        plugin: {
          ...
          description:
            "A desktop plugin sent a notification while Hermes was in the background.",
        },
      },
      ...
      testSent:
        "Test sent. If nothing appears, check your OS notification permissions and Focus/Do Not Disturb.",
      testUnsupported: "This system does not support native notifications.",
      completionSoundTitle: "Completion Sound",
      completionSoundDesc:
        "Plays when an agent turn finishes. Pick a preset and preview it here.",
    ...
    appearance: {
      ...
      reasoningCollapsedDesc:
        "Keep streamed reasoning available without expanding it until you open it.",
      uiScaleTitle: "UI Scale",
      uiScaleDesc: (percent: number) =>
        `Scales text and controls across the whole app. Cmd/Ctrl with +, - and 0 also works. Current: ${percent}%.`,
      sessionDensityTitle: "Session List Density",
      sessionDensityDesc:
        "Choose how much context appears beneath session titles in the sidebar.",
      sessionDensityCompact: "Compact",
      sessionDensityComfortable: "Comfortable",
      sessionDensityDetailed: "Detailed",
      tabStripTitle: "Tab Strip",
      tabStripDesc:
        "Show tabs above a zone. Auto hides them when a zone holds a single pane.",
      tabStripAuto: "Auto",
      ...
      translucencyDesc:
        "See your desktop through the whole window, text and all. Tuned separately for light and dark.",
      ...
      reactionsDesc:
        "iMessage-style emoji tapbacks — react to messages, and Hermes can react to yours.",
      ...
      tipsReset: (count: number) =>
        `Bring back ${count} closed ${count === 1 ? "tip" : "tips"}`,
      toursTitle: "Guided Tours",
      toursDesc:
        "Let Hermes walk you through the app, dimming the screen and spotlighting each step.",
      composerPopoutTitle: "Floating Composer",
      composerPopoutDesc:
        "Allow dragging the composer out of its dock. Turn this off to keep it locked at the bottom.",
      ...
      embedsReset: (count: number) =>
        `Reset ${count} allowed ${count === 1 ? "service" : "services"}`,
      ...
      themeProfileNote: (profile) =>
        `Saved for the ${profile} profile — each profile keeps its own theme.`,
      ...
      pet: {
        ...
        countCapped: (cap, total) =>
          `Showing ${cap} of ${total} — type to narrow it down.`,
        count: (n) => `${n} pet${n === 1 ? "" : "s"}.`,
        uninstall: (name) => `Uninstall ${name}`,
        delete: (name) => `Delete ${name}`,
        deleteTitle: (name) => `Delete ${name}?`,
        deleteBody:
          "This permanently deletes the pet — it can't be reinstalled.",
    ...
    about: {
      ...
      updateReady: (count) =>
        `A new update is ready (${count} change${count === 1 ? "" : "s"} included).`,
    ...
    config: {
      ...
      disableF12Desc:
        "Block F12 from opening Developer Tools. Ctrl+Shift+I (or Cmd+Opt+I on Mac) still works.",
    ...
    quickEntry: {
      ...
      shortcutDesc:
        "Needs at least one modifier, e.g. CommandOrControl+Shift+Space.",
      active: "Shortcut is active.",
      takenBy: "Another app already uses this shortcut — pick a different one.",
      invalidShortcut:
        "Not a valid shortcut. Include at least one modifier key.",
    },
    credentials: {
      pasteKey: "Paste key",
    ...
    connections: {
      ...
      labelTitle: "Name",
      labelDesc:
        "Required. Shown everywhere this instance appears; must be unique (e.g. “Homelab”, “Work laptop”).",
      ...
      headerRemove: "Remove",
      duplicateLocal:
        "This app already manages a local connection — there can only be one.",
      duplicateUrl: (label: string) =>
        `A connection to this gateway URL already exists (“${label}”).`,
      duplicateSsh: (label: string) =>
        `A connection to this SSH host already exists (“${label}”).`,
    ...
    managedUpdates: {
      ...
      updating: "Updating…",
      progress:
        "Draining sessions, updating the remote install, and restoring profiles…",
      updated: "Updated",
      ...
      scopeNotRestored: (profile: string, error: string) =>
        `Profile “${profile}” not restored: ${error}`,
    },
    gateway: {
      ...
      cloudNeedsSignIn:
        "Sign in to Hermes Cloud to discover the agents on your account.",
      cloudSignedInDesc:
        "You are signed in. Pick an agent below; the session refreshes automatically.",
      ...
      restartingMessage:
        "Hermes Desktop will reconnect using the saved settings — the shell stays open.",
      ...
      sshHostPickDesc:
        "A Host alias from ~/.ssh/config, or Custom to type one.",
      ...
      sshHermesPathDesc:
        "Full path to the remote hermes binary. Blank = auto-detect.",
      sshHermesPathPlaceholder: "auto-detect",
      sshTestConnection: "Test SSH",
      sshConnect: "Connect",
      sshButtonsHint:
        "Save applies on the next launch. Connect reconnects now.",
      sshReachable: (host, platform) =>
        `Reachable: ${host} (${platform}) — Hermes found`,
      sshIncompleteHost: "Enter an SSH host before connecting.",
      sshErrUnreachable:
        "Could not reach that host over SSH. Check the host, port, and your network.",
      sshErrAuth:
      ...
      sshErrTimeout:
        "SSH connection timed out. The host may be unreachable or asleep.",
    ...
    mcp: {
      ...
      toggleFailed: (name, enabled) =>
        `Failed to turn ${name} ${enabled ? "on" : "off"}`,
      tabServers: "Servers",
      tabCatalog: "Catalog",
      ...
      catalogInstallStarted: (name) =>
        `Installing ${name}... applies to new sessions when done.`,
      ...
      deepLinkNameInvalid:
        "Names use 1-64 letters, digits, dots, dashes, or underscores.",
      ...
      deepLinkErrorConfig:
        "The link\u2019s config is not valid base64-encoded JSON.",
      deepLinkErrorShape:
        "The config must be a JSON object with a string `url` or `command` field.",
      ...
      importButton: "Import",
      importPlaceholder:
        "Paste an mcp.json snippet, npx/docker command, claude mcp add line, URL, or Cursor link…",
    ...
    model: {
      ...
      notInCatalog:
        "isn't in this provider's model list — calls may fall back to a backup.",
      tasks: {
    ...
    localModels: {
      ...
      quickstartDoneToast: (model) =>
        `${model} is set up — new chats run on this machine.`,
      ...
      upToDateDetail: (tag, backend) =>
        `Running llama.cpp ${tag} (${backend}) — the latest build Hermes ships.`,
      updateToast: (next) =>
        `A newer local engine build (${next}) is available. Update from Settings → Local Models.`,
      activeDetail:
        "New chats use this model — it loads when you send your first message",
      ...
      placementResidentTip:
        "Running entirely in GPU memory at this context window — full speed.",
      placementSpilledTip:
      ...
      pillFullContextTip:
        "Runs at the model's complete context window from the start",
    ...
    providers: {
      ...
      removeTerminalRunning: (provider) =>
        `Running ${provider} disconnect in the terminal…`,
      ...
      localEndpoint: {
        ...
        description:
          "Point Hermes at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).",
      },
    ...
    sessions: {
      ...
      defaultDirUpdated:
        "Default project directory updated — start a new chat (Ctrl/⌘+N) for it to take effect",
    ...
    toolsets: {
      ...
      nousAuthNeededMessage: (provider) =>
        `${provider} is saved but won't activate until you sign in to Nous Portal.`,
      ...
      browserRealProfile: {
        ...
        enabledMessage:
          "New sessions will browse with a snapshot of your default browser profile.",
        disabledTitle: "Real-profile browsing off",
        disabledMessage:
          "The profile snapshot will be deleted; new sessions use a clean browser.",
        ...
        prompt: {
          ...
          bulletSnapshot:
            "Cookies and logins are copied into a managed snapshot.",
          bulletLiveProfile:
            "Your live browser profile is never opened directly.",
  ...
  skills: {
    ...
    toggleToolset: (label, enabled) =>
      `Turn ${label} toolset ${enabled ? "on" : "off"}`,
    ...
    bulkUpdated: (count) =>
      `Updated ${count} ${count === 1 ? "item" : "items"} for new sessions.`,
  ...
  starmap: {
    ...
    subtitle: (nodes, clusters) =>
      `${nodes} skills across ${clusters} categories`,
    ...
    emptyDesc:
      "As Hermes builds skills and memories for your work, they appear here.",
    share: "Share map",
    shareHint:
    ...
    importSuccess: (nodes) =>
      `Loaded a map with ${nodes} ${nodes === 1 ? "node" : "nodes"}.`,
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend:
        "Restart Hermes to use pets — the backend predates this feature.",
      ...
      toggleFailed: (enabled) =>
        `Could not turn the pet ${enabled ? "on" : "off"}.`,
    ...
    generatePet: {
      ...
      backgroundHint:
        "You can close this — Hermes will notify you when it’s done.",
      ...
      referenceImageTooLarge:
        "Reference image is too large. Use one under 16 MB.",
      referenceImageInvalid:
        "Could not read that reference image. Try a PNG, JPG, WebP, or GIF.",
      adopt: "Adopt",
    ...
    maintenance: {
      ...
      debugShareDesc:
        "Upload a redacted report + logs, get shareable links (auto-deletes in 6h)",
  ...
  messaging: {
    ...
    unknown: "Unknown",
    hintPendingRestart:
      "Restart the gateway from the status bar to apply this change.",
    ...
    pendingAria: (count) =>
      `${count} pending pairing ${count === 1 ? "request" : "requests"}`,
    ...
    revokeDesc: (name: string) =>
      `${name} will lose access and stop being recognized on their next message.`,
    ...
    pairingLockedOut:
      "Too many failed approvals — this platform is locked out. Try again later.",
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      savedMessage: (profile: string, host: string) =>
        `${profile} now runs on ${host}`,
      removedTitle: "Remote connection removed",
      removedMessage: (profile: string) =>
        `${profile} now runs on this computer`,
    ...
    cloneFromDesc:
      "Copies config, skills, and SOUL.md from the selected source profile.",
    ...
    displayNameDesc:
      'Sets a display name shown across the app. The internal profile ID stays "default".',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      declined:
        "Model change cancelled — you declined the data-training tier warning.",
    },
    ...
    promptLabel: "Prompt",
    promptPlaceholder:
      "Summarize my unread Slack threads and email me the top 5...",
    ...
    customHint:
      'Cron expression, or phrases like "every hour" or "weekdays at 9am".',
    optional: "Optional",
  ...
  sidebar: {
    ...
    projects: {
      ...
      convertBranchDesc:
        "Open checked-out branches, or create a worktree for a free branch.",
  ...
  composer: {
    ...
    wakeWordPausedVoice: (phrase) =>
      `Wake word: "${phrase}" — paused during voice chat`,
    ...
    attachUrlDesc:
      "Hermes will fetch the page and include it as context for this turn.",
    ...
    queueStuckBody:
      "A queued turn kept failing to send. It is still in the queue — try sending it again.",
    ...
    mcpSuggestions: {
      ...
      tip: (keyword) =>
        `Suggested because you mentioned “${keyword}” — click to connect`,
    ...
    skillSuggestions: {
      ...
      tip: (skill) =>
        `You mentioned “${skill}” — click to lead with that skill`,
    ...
    githubSuggestions: {
      ...
      doneTip:
        "Send the message and the agent walks you through GitHub sign-in",
    },
    repairSuggestions: {
    ...
    cronSuggestions: {
      label: "Schedule this",
      tip: (phrase) =>
        `“${phrase}” sounds recurring — run it on a schedule instead`,
  ...
  statusStack: {
    ...
    coding: {
      ...
      revertConfirm:
        "Discard changes to this file and restore it to the committed state? This cannot be undone.",
      revertAllConfirm:
        "Discard every change and restore files to the committed state? This cannot be undone.",
      staged: "Staged",
  ...
  updates: {
    ...
    unsupportedMessage:
      "This version of Hermes can’t update itself from inside the app.",
    ...
    moreChanges: (count) =>
      `+ ${count} more change${count === 1 ? "" : "s"} included.`,
    ...
    applyingClose:
      "This window will close while the update runs, then Hermes reopens on its own.",
    ...
    applyStatus: {
      ...
      noReturn:
        "Backend didn’t come back online. The update may not have completed — check the backend host.",
    },
  },
  ...
  install: {
    ...
    connectExistingDesc:
      "Use a remote backend with a session token or browser sign-in. No local install will start.",
    installLocalTitle: "Install Hermes locally",
    installLocalDesc:
      "Download Hermes, create its Python environment, and run the backend on this computer.",
    ...
    remoteSetupDesc:
      "Enter your gateway URL. Hermes Desktop will detect whether it needs a token or browser sign-in.",
    remoteUrlTitle: "Gateway URL",
    remoteUrlDesc:
      "Use the base URL of the Hermes gateway, including https:// when remote.",
    ...
    authTitle: "Authentication",
    authNeedsOauth: (provider) =>
      `Sign in with ${provider} before testing this gateway.`,
    ...
    signInIncomplete:
      "The sign-in window closed before authentication completed.",
    tokenTitle: "Session token",
    ...
    testSucceeded: (baseUrl, version) =>
      `Connected to ${baseUrl}${version ? ` (${version})` : ""}.`,
  ...
  onboarding: {
    ...
    connected: "Connected",
    featuredPitch:
      "One subscription, 300+ frontier models — the recommended way to run Hermes",
    fireworksPitch: "Direct model API — Fireworks-hosted frontier models",
    localModelsTitle: "Run models locally",
    localModelsPitch:
      "No account needed — download a model and run it on this machine",
    ...
    localApiKeyPlaceholder:
      "API key (optional — only if your endpoint requires one)",
    couldNotSave: "Could not save credential.",
    connecting: "Connecting",
    update: "Update",
    flowSubtitles: {
    ...
    connectedPicking: (provider) =>
      `${provider} connected. Picking a default model...`,
    ...
    deviceCodeOpened: (provider) =>
      `We opened ${provider} in your browser. Enter this code there:`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      commitsBehind: (count, branch) =>
        `${count} commit${count === 1 ? "" : "s"} behind ${branch}`,
      ...
      cacheHitRateTitle:
        "Prompt cache hit rate this session — cached tokens cost less, so higher is cheaper",
      tokensPerSecondTitle:
        "Output tokens per second, averaged over the last 10 model calls",
      agents: "Agents",
      ...
      session: "Session",
      yoloOn:
        "YOLO on — auto-approving dangerous commands. Shift+click toggles globally.",
      ...
      modelPinned:
        "pinned by you; new chats use this instead of the Settings default",
  ...
  preview: {
    ...
    sourceLineTitle:
      "Click to select · shift-click to extend · drag to composer",
    source: "SOURCE",
    ...
    console: {
      ...
      sentMessage: (count) =>
        `${count} log entr${count === 1 ? "y" : "ies"} added to composer`,
    },
    web: {
      ...
      restartingMessage:
        "Hermes is working in the background. Watch the preview console for progress.",
      startRestartFailed: (message) =>
        `Could not start server restart: ${message}`,
      ...
      blankPageBody:
        "Type an address above to browse, or ask Hermes to open a page.",
      ...
      filesChanged: (count, url) =>
        `${count} file changes, reloading preview: ${url}`,
      ...
      addComments: (count) =>
        count === 1 ? "Add 1 comment" : `Add ${count} comments`,
  ...
  zones: {
    ...
    lastTabKeptBody:
      "This zone needs at least one visible tab. Show another tab first, or collapse the whole sidebar.",
    ...
    pluginDisabledBody:
      "Re-enable it in Settings → Plugins to bring the pane back.",
  ...
  assistant: {
    ...
    clarify: {
      ...
      lateAnswer: (question, choice) =>
        `Re: "${question}" — my answer: ${choice}`,
      lateAnswerTip: "Draft this answer as a follow-up message",
      lateAnswerHint:
        "This prompt is no longer waiting. Pick an option to draft it as a follow-up message.",
    },
    mcpSetup: {
      ...
      reloadFailed:
        "Server saved, but reloading MCP tools failed — they load next session",
      gatewayDisconnected: "Hermes gateway is not connected",
    },
    tool: {
      copyCode: "Copy code",
  ...
  desktop: {
    ...
    noProfileNamed: (target, available) =>
      `No profile named "${target}". Available: ${available}`,
    ...
    readOnlyTranscriptSendBlocked:
      "This chat is open as a read-only transcript — sending is disabled.",
    ...
    cwdStagedMessage:
      "Restart the desktop backend to apply cwd changes to this active session.",
    ...
    handoff: {
      ...
      systemNote: (platform) =>
        `↻ Handed off to ${platform} — resume here anytime.`,
  ...
  errors: {
    ...
    boundaryDesc:
      "The view hit an unexpected error. Your chats and settings are safe.",
    reloadWindow: "Reload window",
    openLogs: "Open logs",
  },
