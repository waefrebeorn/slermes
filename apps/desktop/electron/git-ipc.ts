...
export function registerGitIpc({
  ...
  ipcMain.handle(
    ...
    async (_event, repoPath, worktreePath, options) =>
  ...
  ipcMain.handle("hermes:git:repoStatus", async (_event, repoPath) =>
    repoStatus(repoPath, resolveGitBinary()),
  );
  ...
  ipcMain.handle(
    ...
    async (_event, repoPath, scope, baseRef) =>
      reviewList(repoPath, scope, baseRef, resolveGitBinary()),
  );
  ipcMain.handle(
    "hermes:git:review:diff",
    async (_event, repoPath, filePath, scope, baseRef, staged) =>
      reviewDiff(
        repoPath,
        filePath,
        scope,
  ...
  ipcMain.handle(
    ...
    async (_event, repoPath, filePath) =>
  ...
  ipcMain.handle(
    ...
    async (_event, repoPath, message, push) =>
  ...
  ipcMain.handle("hermes:git:review:push", async (_event, repoPath) =>
    reviewPush(repoPath, resolveGitBinary()),
  );
