# Battleship v47 — Active Gap Map (DA-Corrected)

**Last sweep: Phase 580 — S13 Thread safety**
**Total active gaps: ~71** (S13 #3 Thread safety FIXED v580)
...
**FIXED:** C01 (ASan), C04 (stringop truncation), C06 (credential audit), ~~C13 #2 Null safety~~ ✅ (v572), ~~C14 #3 Thread safety~~ ✅ (v580).
**VERIFIED STALE:** signed vs unsigned — 0 warnings across codebase.
**REMAINING:** FD leaks (P2), stack buf audit (P2), error path coverage (P2), fuzz corpus (P2).
