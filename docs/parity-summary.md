...
|----------------|-------|------------|---------|
| **PORTED** | 13,036 | 92.8% | C11 implementation with PoP annotation |
| **REAL_GAP** | 1,006 | 7.2% | Honest gaps (not yet ported — IO/network/DB/logic; NOT faked) |
...
> **Generated 2026-08-08T21:51:47Z by `make parity-walkway` from the live scanner.** The PORT phase (v398→v667) is legacy — this table is the single source of truth for completeness. Do not hand-edit.
<!-- /PARITY:AUTO -->
