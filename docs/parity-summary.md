...
> **Generated 2026-08-04T04:35:06Z by `make parity-walkway` from the live scanner.** The PORT phase (v398→v667) is legacy — this table is the single source of truth for completeness. Do not hand-edit.
<!-- /PARITY:AUTO -->
