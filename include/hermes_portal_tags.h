...
/** Set / get / reset the ambient conversation id (Python ContextVar equivalent).
...
/** Build a Nous Portal conversation tag from a session id.
 *  @return Newly allocated string "conversation=<session_id>". Caller must free(). */
